(function() {
	(function() {
		...
		function Kc(a, b, c) {
			...
			if (2 < arguments[F]) {
				...
				return function() {
					...
					r[G].unshift[qa](c, d);return a[qa](b, c)
				}
			}
			return function() {
		...
		function Lc(a, b, c) {
			Lc = Function[G].bind && -1 != Function[G].bind[E]()[fa](Yb) ? Jc : Kc;return Lc[qa](h, arguments)
		}
		function Mc(a, b) {
			var c = r[G][ea][H](arguments, 1);
			return function() {
				var b = r[G][ea][H](arguments);
				b.unshift[qa](b, c);return a[qa](this, b)
			}
		}
		function Nc(a, b) {
			function c() {
		...
		function Oc(a) {
			...
			for (var b = Pc() + Ka, a = o[ka]($a), c = 0; c < a[F]; c++)
				if (a[c] && a[c].href && a[c].href == b) break a;
		...
		function T(a, b, c) {
			...
			c = a[fa](M);-1 == c && (c = a[F]);
			b = t.max(0, b - c);return r(b + 1)[J](N) + a
		}
		function Qc(a, b) {
		...
		function Uc(a) {
			...
			4 == a[F] && (a = a[z](Xc, xa));return a[sa]()
		}
		function Yc(a) {
			a = Uc(a);return [ m(a[la](1, 2), 16), m(a[la](3, 2), 16), m(a[la](5, 2), 16) ]
		}
		function Wc(a, b, c) {
			a = k(a);
			b = k(b);
			c = k(c);
			if (ba(a) || 0 > a || 255 < a || ba(b) || 0 > b || 255 < b || ba(c) || 0 > c || 255 < c)
				throw l('"(' + a + Ga + b + Ga + c + '") is not a valid RGB color');
		...
		function $c(a) {
			S(a) || (a = {});
			this.wa = ac;S(a.fill) && this.xa(a.fill);
			this.va = 1;S(a.Q) && this.ya(a.Q);
			this.sa = ac;S(a.stroke) && this.Aa(a.stroke);
			this.Ha = 1;S(a.Ga) && this.P(a.Ga);
			this.Fa = 1;S(a.R) && this.Ca(a.R);
			this.Ea = lc;S(a.Da) && this.Ba(a.Da);
			this.e = h;
			if (a.e) {
				var b = a.e,
					c = {},
			...
			this.b = h;a.pattern && this.za(a.pattern)
		}
		R = $c[G];
		R.xa = function(a) {
			this.wa = Zc(a)
		...
		function bd(a, b, c) {
			a = Gc(b, a);return S(a) && Hc(c) == Fb ? c(a) : a
		}
		R = ad[G];
		R.d = function(a, b, c) {
		...
		function cd(a) {
			...
			a = K + a;return a == Ma || a[sa]() == wc ? aa : a == N || a[sa]() == Bb ? i : h
		}
		R.La = function(a, b) {
			var c = this.Nb(a);
			if (S(c)) return c;
		...
		;!pd || Cd(9);!qd && !pd || pd && Cd(9) || qd && (Ad["1.9.1"] || (Ad["1.9.1"] = 0 <= Qc(zd, "1.9.1")));pd && (Ad["9"] || (Ad["9"] = 0 <= Qc(zd, "9")));
		function Pc() {
			var a = Gc(Kb);
			S(a) || (a = Rb);var b = Gc(Lb);
			S(b) || (b = Na);return a + Ia + b
		}
		;
		function Dd(a) {
			this.L = a || {};Ed || (Ed = Pc() + Ja)
		}
		var Ed = h,
			Fd = {
				red : gc,
			...
			if (a[ga](b) == P) {
				...
				for (var Q = t[y]((n - d) / f * p), W = p - Q, v = 0; v < a[ma](); v++) {
					var s = a[ia](v, b),
						...
						s = t.max(d, t.min(e, s)),
						ra = t.ceil((s - d) / f * p);
					w[x](Sa);U(ic, 1, w);var fc = Gd(c.colorPositive, pb),
						Td = Gd(c.colorNegative, gc),
						ab = c.drawZeroLine ? 1 : 0;
					0 < Q ? s < n ? (U(zc, ra, w), U(Td, Q - ra, w), 0 < ab && U(Bc, ab, w), U(zc, W, w)) : (U(zc, Q, w), 0 < ab && U(Bc, ab, w), U(fc, ra - Q, w), U(zc, p - ra, w)) : (U(fc, ra, w), U(zc, p - ra, w));U(ic, 1, w);
					s = a.getProperty(v, b, lb);s == h && (s = a.getFormattedValue(v, b), a[pa](v, b, lb, s));B && (w[x](Cc), w[x](s));w[x](Qa);a[oa](v, b, w[J](K))
				}
			}
		});
		function Gd(a, b) {
			a = (a || K)[sa]();return Fd[a] || b
		}
		;
		function Hd(a, b, c, d) {
			Ic(a) && (a = a[ja]());Ic(b) && (b = b[ja]());Hc(a) == ob && (a = Id(a));Hc(b) == ob && (b = Id(b));
			this.ha = a;
			this.rb = b;
			this.pb = c;
			this.sb = d
		...
		Hd[G].contains = function(a) {
			...
			Ic(a) ? a = a[ja]() : Hc(a) == ob && (a = Id(a));return (b == h || a >= b) && (c == h || a < c)
		};
		Hd[G].na = function() {
			return this.sb
		};
		...
		Jd[G].na = function(a) {
			...
			var c = this.ob,
				...
				a = t.min(t.max(a, 0), 1);
			b = [ t[y](a * b[0] + (1 - a) * c[0]), t[y](a * b[1] + (1 - a) * c[1]), t[y](a * b[2] + (1 - a) * c[2]) ];return Wc(b[0], b[1], b[2])
		};
		function V() {
			this.w = []
		}
			...
			if (c == P || c == nc || c == yb || c == zb || c == uc)
				for (c = 0; c < a[ma](); c++) {
					for (var d = a[ia](c, b), e = K, f = 0; f < this.w[F]; f++) {
						...
						if (n.contains(d)) {
							f = n.pb;
							d = n.na(d);f && (e += wb + f + Pa);d && (e += qb + d + Pa);break
						}
					}
					a[pa](c, b, oc, e)
			}
		...
		function Ld(a) {
			if (typeof a == P) {
				...
				if (0 == c)
					c = Ua;else {
					var d = [ Ua, 0 > c ? L : Fa ];
					c = t.abs(c);d[x](t[A](c / 60) % 100);
					c %= 60;0 != c && d[x](Oa, T(c, 2));
					c = d[J](K)
				}
				b.ma = c;
		...
		R.Ib = function(a) {
			var a = this.K(a),
				b = [ Wa ];
			b[x](0 >= a ? Fa : L);
			a = t.abs(a);b[x](T(t[A](a / 60) % 100, 2), Oa, T(a % 60, 2));return b[J](K)
		};
		R.Jb = function(a) {
		...
		R.Kb = function(a) {
			var a = -this.K(a),
				b = [ 0 > a ? L : Fa ],
				a = t.abs(a);
			b[x](T(t[A](a / 60) % 100, 2), T(a % 60, 2));return b[J](K)
		};
		R.Lb = function(a) {
		...
		R.c = function(a) {
			for (; a;)
				for (var b = 0; b < Nd[F]; ++b) {
					...
					if (c) {
						c = c[0];
						a = a[I](c[F]);0 == b && (c == Ba ? c = Aa : (c = c[I](1, c[F] - 1), c = c[z](/\'\'/, Aa)));this.u[x]({
							text : c,
							type : b
						});break
					}
		...
		R.jb = function(a, b) {
			var c = b.getFullYear();
			0 > c && (c = -c);return 2 == a ? T(c % 100, 2) : K + c
		};
		R.ab = function(a, b) {
			var c = b.getMonth();
			switch (a) {
			case 5:
				return X.ub[c];case 4:
				return X.tb[c];case 3:
				return X.vb[c];default:
				return T(c + 1, a)
			}
		};
		R.Ua = function(a, b) {
		...
		R.eb = function(a, b) {
			...
			switch (a) {
			case 5:
				return X.yb[c];case 4:
				return X.Bb[c];case 3:
				return X.Ab[c];default:
				return T(c, 1)
			}
		};
		R.fb = function(a, b) {
			...
			switch (a) {
			case 5:
				return X.xb[c];case 4:
				return X.wb[c];case 3:
				return X.zb[c];default:
				return T(c + 1, a)
			}
		};
		R.bb = function(a, b) {
		...
		R.hb = function(a, b, c) {
			c = c || Ld(b[ta]());return 4 > a ? c.Kb(b) : c.Ib(b)
		};
		R.ib = function(a, b, c) {
			c = c || Ld(b[ta]());return 4 > a ? c.Lb(b) : c.Jb(b)
		};
		R.gb = function(a, b) {
			b = b || Ld(a[ta]());return b.ma
		};
		R.qb = function(a, b, c, d, e) {
			var f = a[F];
			switch (a[C](0)) {
			case Va:
				return this.Ya(f, c);case Ac:
				return this.jb(f, c);case bb:
				return this.ab(f, c);case Sb:
				return this.Ua(f, d);case db:
				return this.Za(f, d);case Ta:
				return this.Xa(f, c);case mb:
				return this.Va(f, d);case Nb:
				return this.Ta(f, d);case Ya:
				return this.Ra(f, d);case Xa:
				return this.Sa(f, d);case tb:
				return this.eb(f, c);case Za:
				return this.fb(f, c);case cb:
				return this.bb(f, c);case xb:
				return this.Wa(f, c);case Vb:
				return this.$a(f, d);case ic:
				return this.cb(f, d);case xc:
				return this.gb(b,
					e);case Bc:
				return this.ib(f, b, e);case gb:
				return this.hb(f, b, e);default:
				return K
			}
		};
		function Y(a) {
		...
		Y[G].la = function(a) {
			var b = this.b;
			S(b) || (b = Qd(a, this.lb));return new Md(b)
		};
		Y[G].s = function(a, b) {
			if (b === h) return K;
			var c = this.Y;
			c == h && (c = Ld(b[ta]()));return a[D](b, c)
		};
		function Rd(a, b) {
			var c = [ N ],
				d = Sd[b][0] & 7;
		...
		R.q = function(a) {
			...
			b[x](c ? this.m : this.A);return b[J](K)
		});
		R.D = function(a, b, c) {
		...
		R.Qa = function(a, b) {
			if (0 == a) this.D(a, this.a, b), this.ea(0, b);else {
				...
				if (1 < this.p && this.p > this.a) {
					...
					1 > this.a ? (c++, a /= 10) : (c -= this.a - 1, a *= t.pow(10, this.a - 1));
				this.D(a, d, b);this.ea(c, b)
			}
		};
		R.t = function(a, b) {
			for (var c = K, d = i, e = a[F]; b[0] < e; b[0]++) {
				var f = a[C](b[0]);
				if (f == Aa)
					b[0] + 1 < e && a[C](b[0] + 1) == Aa ? (b[0]++, c += Aa) : d = !d;
				else if (d)
					c += f;else switch (f) {
					case wa:
					case N:
		...
		R.mb = function(a, b) {
			for (var c = -1, d = 0, e = 0, f = 0, n = -1, p = a[F], B = aa; b[0] < p && B; b[0]++) switch (a[C](b[0])) {
				case wa:
					...
					break;case M:
					if (0 <= c)
						throw l('Multiple decimal separators in pattern "' + a + '"');
					c = d + e + f;
					break;case Ta:
					if (this.n)
						throw l('Multiple exponential symbols in pattern "' + a + '"');
					this.n = aa;this.o = 0;
			...
			if (a[ga](b) == P)
				for (var c = 0; c < a[ma](); c++) {
					...
					if (d != h) {
						...
						a[oa](c, b, e);!/^[\s\xa0]*$/[da](this.G == h ? K : K + this.G) && 0 > d && a[pa](c, b, oc, wb + this.G + Pa)
					}
			}
		});
		$[G].formatValue = function(a) {
			var b = h,
				b = a / this.T;
			this.b === h ? (this.S && (b = t.abs(b)), b = this.s(b), b = this.Ia + b + this.Ja, this.S && 0 > a && (b = Ca + b + Ea)) : b = (new Ud(this.b))[D](b);return b
		};
		$[G].s = function(a) {
			0 == this.i && (a = t[y](a));
			var b = [];
			...
			var c = t.pow(10, this.i),
				...
				c = K + d % c;
			if (3 < a[F] && this.F) {
				d = a[F] % 3;0 < d && (b[x](a[I](0, d), this.F), a = a[I](d));
				for (; 3 < a[F];) b[x](a[I](0, 3), this.F), a = a[I](3)
			}
			b[x](a);0 < this.i && (b[x](this.Ka), c[F] < this.i && (c = La + c), b[x](c[I](c[F] - this.i)));return b[J](K)
		};
		function Yd(a) {
			this.b = a || K
		}
		...
		});j("google.visualization.NumberFormat", $);q($[G], O, $[G][D]);q($[G], "formatValue", $[G].formatValue);j("google.visualization.NumberFormat.DECIMAL_SEP", Vd);j("google.visualization.NumberFormat.GROUP_SEP", Wd);j("google.visualization.NumberFormat.DECIMAL_PATTERN", Xd);j("google.visualization.ColorFormat", V);q(V[G], O, V[G][D]);q(V[G], "addRange", V[G].addRange);q(V[G], nb, V[G].addGradientRange);j("google.visualization.BarFormat", Dd);q(Dd[G], O, Dd[G][D]);j("google.visualization.ArrowFormat", Oc);q(Oc[G], O, Oc[G][D]);
	...
	(function() {
		...
		function hn(a, b, c) {
			...
			if (2 < arguments[B]) {
				...
				return function() {
					...
					oa[D].unshift[Ad](c, d);return a[Ad](b, c)
				}
			}
			return function() {
		...
		function jn(a, b, c) {
			jn = Function[D][kc] && -1 != Function[D][kc][yc]()[v](Nk) ? gn : hn;return jn[Ad](k, arguments)
		}
		function kn(a, b) {
			var c = oa[D][hb][G](arguments, 1);
			return function() {
				var b = oa[D][hb][G](arguments);
				b.unshift[Ad](b, c);return a[Ad](this, b)
			}
		}
		...
		function mn(a) {
			if (O[Nd]) O[Nd](a, qg);
				...
				if (nn == k && (O.eval(Bm), "undefined" != typeof O._et_ ? (
						delete O._et_
						, nn = i) : nn = l), nn) O.eval(a);else {
					var b = O[Nc],
						c = b[Pb](El);
					Ca(c, fm);
					c.defer = l;c[Ya](b[qb](a));b[ad][Ya](c);b[ad][bd](c)
			}
		...
		function pn(a) {
			return function(b) {
				google[E][Gd][id](a);
				var c = b[Nb]();
				c && google[E][Gd].addErrorFromQueryResponse(a, b);return !c
			}
		}
		;
		function qn(a) {
			...
			if (/^\s*$/[cb](a) ? 0 : /^[\],:{}\s\u2028\u2029]*$/[cb](a[u](/\\["\\\/bfnrtu]/g, Ff)[u](/"[^"\\\n\r\u2028\u2029\x00-\x08\x10-\x1f\x80-\x9f]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g, gh)[u](/(?:^|:|,)(?:[\s\u2028\u2029]*\[)+/g, J))) try {
					return eval(pe + a + se)
				} catch (b) {} e(n("Invalid JSON string: " + a))
		}
		function rn(a) {
			this.Wd = a
		}
		...
		rn[D].nh = function(a, b) {
			b[s](Xd, a[u](tn, function(a) {
				...
				var b = a[rd](0),
					f = fh;
				16 > b ? f += kf : 256 > b ? f += jf : 4096 > b && (f += ff);return sn[a] = f + b[yc](16)
			}), Xd)
		};
		...
		function un(a) {
			a = vn(a, wn);return (new rn(g)).cl(a)
		}
		function xn(a) {
			qn(a);return yn(a)
		}
		function yn(a) {
			a = zn(a);return eval(pe + a + se)
		}
		function vn(a, b) {
			var a = b(a),
				c = Vm(a);
		...
		function wn(a) {
			Zm(a) && (a = 0 !== a.getMilliseconds() ? [ a[ld](), a[Ac](), a.getDate(), a.getHours(), a.getMinutes(), a.getSeconds(), a.getMilliseconds() ] : 0 !== a.getSeconds() || 0 !== a.getMinutes() || 0 !== a.getHours() ? [ a[ld](), a[Ac](), a.getDate(), a.getHours(), a.getMinutes(), a.getSeconds() ] : [ a[ld](), a[Ac](), a.getDate() ], a = Xf + a[Ld](ve) + se);return a
		}
		;
		function An(a) {
		...
		var Dn = /^[a-zA-Z0-9\-_.!~*'()]*$/;
		function En(a) {
			a = J + a;return !Dn[cb](a) ? aa(a) : a
		}
		function Fn(a, b) {
			if (b) return a[u](Gn, ge)[u](Hn, ie)[u](In, he)[u](Jn, je);
			if (!Kn[cb](a)) return a;
			-1 != a[v](fe) && (a = a[u](Gn, ge));-1 != a[v](yf) && (a = a[u](Hn, ie));-1 != a[v](Df) && (a = a[u](In, he));-1 != a[v](Xd) && (a = a[u](Jn, je));return a
		}
		var Gn = /&/g,
			Hn = /</g,
			In = />/g,
		...
		Nn[D].floor = function() {
			pa(this, q[kb](this[t]));Wa(this, q[kb](this[I]));return this
		};
		Nn[D].round = function() {
			pa(this, q.round(this[t]));Wa(this, q.round(this[I]));return this
		};
		var On = na("^(?:([^:/?#.]+):)?(?://(?:([^/?#]*)@)?([\\w\\d\\-\\u0100-\\uffff.%]*)(?::([0-9]+))?)?([^?#]+)?(?:\\?([^#]*))?(?:#(.*))?$");
		function Pn(a) {
			return a && ka(a)
		...
		var Ko = Ao,
			...
			Oo = Ho(),
			Po = Oo && Oo.platform || J;
		Fo = -1 != Po[v]("Mac");Po[v]("Win");Po[v]("Linux");
		...
		function op(a) {
			...
			if (Mo && !$o(of) && !No) {
				...
				var b = a.innerHeight,
					c = a[Nc][uc][Sb];
				a == a.top && c < b && (b -= 15);return new Nn(a.innerWidth, b)
			}
			a = pp(b) ? b[uc] : b[ad];return new Nn(a[Jc], a[pd])
		}
		function qp(a) {
		...
		function sp(a, b) {
			...
			c = a[Pb](c);d && (R(d) ? Oa(c, d) : Q(d) ? gp[Ad](k, [ c ][ob](d)) : mp(c, d));2 < b[B] && tp(a, c, b, 2);return c
		}
		function tp(a, b, c, d) {
			function f(c) {
				c && b[Ya](R(c) ? a[qb](c) : c)
		...
		function Cp(a) {
			...
			var b = kp(a)[Pb](ti);
			b[Ya](a.cloneNode(i));return b.innerHTML
		}
		var Dp = {
				SCRIPT : 1,
				STYLE : 1,
		...
		function Hp(a) {
			var b = [];
			Ip(a, b, l);return b[Ld](J)
		}
		function Ip(a, b, c) {
			if (!(a[Bb] in Dp))
				if (3 == a[ib])
					c ? b[s]((J + a.nodeValue)[u](/(\r\n|\r|\n)/g, J)) : b[s](a.nodeValue);
				else if (a[Bb] in Ep) b[s](Ep[a[Bb]]);else
		...
		function Mp(a, b, c) {
			...
			else if (Ym(a) || R(a)) co(a, b, c);else {
				var d;
				if (typeof a.Tb == Mi)
					d = a.Tb();
		...
		N.remove = function(a) {
			return Op(this.O, a) ? (
				delete this.O[a]
				, this.m--, this.Jb++, this.D[B] > 2 * this.m && this.Bd(), i) : l
		};
		N.Bd = function() {
			if (this.m != this.D[B]) {
				for (var a = 0, b = 0; a < this.D[B];) {
					var c = this.D[a];
					Op(this.O, c) && (this.D[b++] = c);a++
				}
				Ma(this.D, b)
			}
			if (this.m != this.D[B]) {
		...
		N.Qd = function(a) {
			...
			Pa(j, function() {
				for (;;) {
					f != h.Jb && e(n("The map has changed since the iterator was created"));b >= c[B] && e(Jp);var j = c[b++];
					return a ? j : d[j]
				}
			});return j
		};
		...
		var Vp = !T || bp(9),
			Wp = !T || bp(9),
			Xp = T && !$o(tf);
		!Mo || $o(qf);Lo && $o("1.9b") || T && $o(tf) || Ko && $o("9.5") || Mo && $o(qf);!Lo || $o(tf);
		function Yp(a, b) {
			Ca(this, a);Sa(this, b);sa(this, this[ed])
		}
		S(Yp, Rp);
		N = Yp[D];
		N.k = function() {
		...
		N.relatedTarget = k;
		N.offsetX = 0;
		N.offsetY = 0;Ha(N, 0);Ia(N, 0);va(N, 0);wa(N, 0);
		N.button = 0;ya(N, 0);
		N.charCode = 0;
		N.ctrlKey = l;
		N.altKey = l;
		...
		N.Pb = function(a, b) {
			var c = Ca(this, a[z]);
			Yp[G](this, c);Sa(this, a[ed] || a.srcElement);sa(this, b);
			var d = a[eb];
			if (d) {
				if (Lo) {
					var f;
			...
			this.offsetY = Mo || a.offsetY !== g ? a.offsetY : a.layerY;Ha(this, a[sc] !== g ? a[sc] : a.pageX);Ia(this, a[tc] !== g ? a[tc] : a.pageY);va(this, a[Eb] || 0);wa(this, a[Fb] || 0);
			this.button = a.button;ya(this, a[Tb] || 0);
		...
		function rq(a, b) {
			...
			if (R(b))
				b = new Yp(b, a);
			else if (b instanceof Yp) Sa(b, b[ed] || a);else {
				var f = b,
					b = new Yp(c, a);
				zo(b, f)
			}
		...
		N.send = function(a, b, c, d) {
			...
			this.u.onreadystatechange = jn(this.cg, this);try {
			...
			d && Mp(d, function(a, b) {
				h.set(b, a)
			});b == Fg && !h.Pa(Uf) && h.set(Uf, sh);Mp(h, function(a, b) {
		...
		yq.send = function(a, b, c, d, f, h) {
			var j = new yq;
			Aq[s](j);b && hq(j, ai, b);hq(j, sl, kn(Bq, j));h && j.gl(h);j[Jb](a, c, d, f)
		};
		yq.Fl = function() {
			for (; Aq[B];) Aq.pop().Q()
		};
		...
		N.toString = function() {
			...
			var a = [];
			this.Ga && a[s](Eq(this.Ga, Fq), uf);this.hb && (a[s]($e), this.Eb && a[s](Eq(this.Eb, Fq), Ff), a[s](R(this.hb) ? aa(this.hb) : k), this.Qa != k && a[s](uf, J + this.Qa));this.ja && (this.xe() && this.ja[pb](0) != Ye && a[s](Ye), a[s](Eq(this.ja, this.ja[pb](0) == Ye ? Gq : Hq)));
			var b = J + this.Z;
			b && a[s](Ef, b);this.Db && a[s](ae, Eq(this.Db, Iq));return this.ra = a[Ld](J)
		};
		N.Pj = function(a) {
			var b = this[cd](),
				c = a.Fi();
			...
			c ?
				b.xc(d) : c = a.Ei();
			c ? b[$c](a.Bi()) : c = a.Ci();c && b.hd(a.Db);return b
		};Ra(N, function() {
			var a = this.Ga,
				b = this.Eb,
				c = this.hb,
				...
				j = this.Db,
				o = new Cq(k, this.Fa);
			a && o.zc(a);b && o.jd(b);c && o.gd(c);d && o.yc(d);f && o.xc(f);h && o.Ae(h);j && o.hd(j);return o
		});
		N.zc = function(a, b) {
			this.Ua();
			delete this.ra;
		...
		N.jd = function(a, b) {
			this.Ua();
			delete this.ra;
			this.Eb = b ? a ? ka(a) : J : a;return this
		};
		N.Gi = function() {
			return !!this.Eb
		};
		N.gd = function(a, b) {
			this.Ua();
			delete this.ra;
			this.hb = b ? a ? ka(a) : J : a;return this
		};
		N.xe = function() {
			return !!this.hb
		};
		N.yc = function(a) {
			this.Ua();
			delete this.ra;
			a ? (a = ca(a), (la(a) || 0 > a) && e(n("Bad port number " + a)), this.Qa = a) : this.Qa = k;return this
		};
		N.Di = function() {
			return this.Qa != k
		};
		N.xc = function(a, b) {
			this.Ua();
			delete this.ra;
			this.ja = b ? a ? ka(a) : J : a;return this
		};
		N.ug = function() {
			return !!this.ja
		};
		...
		N.Ae = function(a, b) {
			this.Ua();
			delete this.ra;
			a instanceof Dq ? (this.Z = a, this.Z.af = this, this.Z.fc(this.Fa)) : (b || (a = Eq(a, Jq)), this.Z = new Dq(a, this, this.Fa));return this
		};
		...
		N.hd = function(a, b) {
			this.Ua();
			delete this.ra;
			this.Db = b ? a ? ka(a) : J : a;return this
		};
		N.Ci = function() {
			return !!this.Db
		};
		N.Jj = function() {
			this.Ua();this.nd(Lm, q[kb](2147483648 * q.random())[yc](36) + q.abs(q[kb](2147483648 * q.random()) ^ ln())[yc](36));return this
		};
		N.Ua = function() {
			this.Yk && e(n("Tried to modify a read-only Uri"))
		};
		N.fc = function(a) {
			this.Fa = a;this.Z && this.Z.fc(a);return this
		};
		var Kq = /^[a-zA-Z0-9\-_.!~*'():\/;?]*$/;
		function Eq(a, b) {
			var c = k;
			R(a) && (c = a, Kq[cb](c) || (c = encodeURI(a)), 0 <= c.search(b) && (c = c[u](b, Lq)));return c
		}
		function Lq(a) {
			a = a[rd](0);return ce + (a >> 4 & 15)[yc](16) + (a & 15)[yc](16)
		}
		var Fq = /[#\/\?@]/g,
			Hq = /[\#\?:]/g,
			Gq = /[\#\?]/g,
		...
		N.Ta = function() {
			if (!this.z && (this.z = new Np, this.m = 0, this.Za))
				for (var a = this.Za[Pc](fe), b = 0; b < a[B]; b++) {
					...
					d = ka(d[u](/\+/g, Sd));
					d = this.Kb(d);this.add(d, f ? ka(f[u](/\+/g, Sd)) : J)
			}
		};
		N.z = k;
		N.m = k;
		N.Nd = function() {
			this.Ta();return this.m
		};
		N.add = function(a, b) {
			this.Ta();this.Fc();
			a = this.Kb(a);
		...
		N.remove = function(a) {
			...
			if (this.z.Pa(a)) {
				this.Fc();
				var b = this.z.get(a);
				Q(b) ? this.m -= b[B] : this.m--;return this.z[Mb](a)
			}
			return l
		};Ea(N, function() {
			this.Fc();this.z && this.z.clear();
			this.m = 0
		});
		N.Pa = function(a) {
			this.Ta();
			a = this.Kb(a);return this.z.Pa(a)
		};
		N.Tb = function() {
			this.Ta();
		...
		N.set = function(a, b) {
			...
			this.z.set(a, b);this.m++;return this
		};
		N.get = function(a, b) {
			this.Ta();
			a = this.Kb(a);
		...
		function Mq(a, b, c) {
			(typeof b != Uk || !(Zh in b)) && e(n(c + ' must have a property "column"'));ki in b && typeof b.desc != Ch && e(n('Property "desc" in ' + c + " must be boolean."));U(a, b.column)
		}
		function Nq(a, b) {
			...
			if (typeof b == Uk) {
				if (Ym(b)) {
					...
					if (typeof b[0] == Uk) {
						for (var d = 0; d < b[B]; d++) {
							Mq(a, b[d], Tl + d + gh);var f = b[d].column;
							f in c && e(n(Sf + f + Ud));
							c[f] = i
						}
						return b
			...
			if (c != k) {
				...
				case hi:
					...
					if (Ym(c) && 2 < c[B] && 5 > c[B]) {
						...
						if (0 > c[0] || 23 < c[0] || 0 > c[1] || 59 < c[1] || 0 > c[2] || 59 < c[2])
							d = l;
		...
		function Qq(a, b, c) {
			...
			case gi:
			case hi:
				return b < c ? -1 : c < b ? 1 : 0;case im:
				for (a = 0; 3 > a; a++) {
					if (b[a] < c[a]) return -1;
					if (c[a] < b[a]) return 1
				}
				b = 4 > b[B] ? 0 : b[3];c = 4 > c[B] ? 0 : c[3];return b < c ? -1 : c < b ? 1 : 0
			}
		}
		function Rq(a, b) {
			U(a, b);var c = a[Ub](b),
		...
		function Vq(a, b) {
			...
			for (var c = {}, d = 0; d < b[B]; d++) {
				if (typeof b[d] != Uk || !(Zh in b[d]))
					zm in b[d] || Dk in b[d] || yk in b[d] ? zm in b[d] && (Dk in b[d] || yk in b[d]) && e(n($h + d + '] must specify either "value" or range properties ("minValue" and/or "maxValue"')) : e(n($h + d + '] must have properties "column" and "value", "minValue"or "maxValue"'));
				var f = b[d].column;
				f in c && e(n(Sf + f + " is duplicate in columnFilters."));U(a, f);Pq(a, f, b[d][sb]);
				c[f] = i
			}
			c = [];
			d = a[Dc]();
		...
		function Wq(a, b) {
			...
			b == im ? (c = [], c[s](a[0]), c[s]((10 > a[1] ? ff : J) + a[1]), c[s]((10 > a[2] ? ff : J) + a[2]), c = c[Ld](uf), 3 < a[B] && 0 < a[3] && (c += Ve + (10 > a[3] ? jf : 100 > a[3] ? ff : J) + a[3])) : b == gi ? (c = new google[E].DateFormat({
				...
				formatType : zk,
				valueType : hi
			}), c = c.formatValue(a)) : c = J + a;return c
		}
		function Xq(a, b, c, d) {
		...
		function V(a, b) {
			...
			if (a) {
				if (R(a))
					a = xn(a);else a:
					for (var c = a.cols || [], d = a[zd] || [], f = c[B], h = 0; h < f; h++) {
						var j = c[h][z];
						if (j == gi || j == hi)
		...
		N.getColumnPattern = function(a) {
			U(this, a);return this.B[a].pattern
		};
		N.getColumnRole = function(a) {
			a = this[Qc](a, Bl);return a = R(a) ? a : J
		};
		N.getColumnType = function(a) {
			U(this, a);return this.B[a][z]
		};
		Ga(N, function(a, b) {
			Oq(this, a);U(this, b);
			var c = this.Nc(a, b),
		...
		N.getProperty = function(a, b, c) {
			Oq(this, a);U(this, b);return (a = (a = this.Nc(a, b)) && a.p) && c in a ? a[c] : k
		};
		N.getProperties = function(a, b) {
			...
			c || (c = {
				v : k,
				f : k
			}, this.G[a].c[b] = c);c.p || (c.p = {});return c.p
		};
		...
		N.setCell = function(a, b, c, d, f) {
			...
			"undefined" != typeof d && (h.f = d);Wm(f) && (h.p = $m(f) ? f : {})
		};
		...
		N.getColumnProperties = function(a) {
			U(this, a);
			a = this.B[a];a.p || (a.p = {});return a.p
		};
		N.insertColumn = function(a, b, c, d) {
			a !== this.B[B] && U(this, a);$m(b) || (b = {
				id : d || J,
				label : c || J,
				pattern : J,
				type : b
			});
			c = b[z];uo(Yq, c) || e(n("Invalid type: " + c + Ve));
		...
		N.addColumn = function(a, b, c) {
			this.insertColumn(this.B[B], a, b, c);return this.B[B] - 1
		};
		N.Hj = function(a, b) {
			var c = {};
			if (Vm(b) == Uk && !Zm(b)) {
		...
		N.insertRows = function(a, b) {
			...
			kn(mo, this.G, a, 0)[Ad](k, d);return a + d[B] - 1
		};
		...
		N.addRow = function(a) {
			...
			P(a) && e(n("If argument is given to addRow, it must be an array, or null"));return this[pc](1)
		};
		...
		N.removeColumns = function(a, b) {
			if (!(0 >= b)) {
				U(this, a);a + b > this.B[B] && (b = this.B[B] - a);this.B[Kd](a, b);
		...
		function Zq(a) {
			...
			this.qb = [];
			this.qb = a.warnings || [];
			this.pb = a[Gd] || [];ar(this.qb);ar(this.pb);
		...
		function dr(a, b) {
			var c = b || {};
			this.qf = c.sendMethod || vh;uo(er, this.qf) || e(n("Send method not supported: " + this.qf));
			this.Og = c.makeRequestParams_ || {};$n(a) && (a = this.kk(a));var d = a,
				c = $n(d),
				d = Pn(Qn(5, d)),
				d = Un[cb](d);
			this.Lj = c && d;
			this.Kj = a;
			this.Gg = fr++;gr[s](this)
		}
		var er = {
				Dl : Jm,
				El : Km,
		...
		N.kk = function(a) {
			...
			var c = b.ja,
				c = c[u](/\/ccc$/, df);
			/\/pub$/[cb](c) && (c = c[u](/\/pub$/, df), b.nd(ol, lf));b.xc(c);
			var c = Pn(Qn(3, a)),
				a = (ca(Qn(4, a)) || k) != k,
				d = Yn[cb](c),
				c = Zn[cb](c) && !d && a;
			b.zc(c ? Uj : Zj);return b[yc]()
		};
		function lr(a) {
		...
		N.Nj = function(a) {
			...
			a = b;this.Gb && (b = new Cq(a), Mo && b.Jj(), a = b[yc]());return a
		};
		N.Jd = function() {
			...
			if (b == wk)
				Sm(Oi) ? this.Qj(a, this.Og) : e(n("gadgets.io.makeRequest is not defined."));else {
				if (!(d = b ==
						Jm)) {
		...
		N.Qj = function(a, b) {
			...
			b.OAUTH_ENABLE_PRIVATE_NETWORK == k && (b.OAUTH_ENABLE_PRIVATE_NETWORK = i);b.OAUTH_ADD_EMAIL == k && (b.OAUTH_ADD_EMAIL = i);jr.io.makeRequest(a, jn(this.Ik, this), b);this.zh()
		};
		N.Ik = function(a) {
			if (a != k && a.data) mn(zn(a.data));else {
				var b = J;
				a && a[Gd] && (b = a[Gd][Ld](Sd));this.Lh(xk, Pi, b)
			}
		};
		N.uf = function(a) {
			this.zh();on(a);this.sh()
		};
		N.zh = function() {
			var a = this;
			this.sf();
		...
		N.setRefreshable = function(a) {
			typeof a != Ch && e(n("Refreshable must be a boolean"));return this.tf = a
		};
		...
		O.gadgets && !qr() && on("http://www.gmodules.com/gadgets/rpc/rpc.v.js");pr(We);
		function rr(a) {
		...
		N.dh = function(a, b) {
			...
			if (Vm(a) == K) {
				!Vm(b) == K && e(n("If first parameter is a number, second parameter must be specified and be a number."));a > b && e(n("The first parameter (min) must be smaller than or equal to the second parameter (max)."));Oq(this.h, a);Oq(this.h, b);
		...
		N.getTableColumnIndex = function(a) {
			U(this, a);
			a = this.s[a];return an(a) ? a : $m(a) && an(a.sourceColumn) ? a.sourceColumn : -1
		};
		N.getUnderlyingTableColumnIndex = function(a) {
			a = this.getTableColumnIndex(a);
			if (-1 == a) return a;
			bn(this.h.getUnderlyingTableColumnIndex) && (a = this.h.getUnderlyingTableColumnIndex(a));return a
		};
		N.getTableRowIndex = function(a) {
			Oq(this, a);return this.Xa ? a : this.Wa[a]
		};
		N.getUnderlyingTableRowIndex = function(a) {
			a = this[Zb](a);bn(this.h.getUnderlyingTableRowIndex) && (a = this.h.getUnderlyingTableRowIndex(a));return a
		};
		N.getNumberOfRows = function() {
		...
		N.getColumnId = function(a) {
			U(this, a);
			a = this.s[a];return an(a) ? this.h.getColumnId(a) : a.id || J
		};
		N.getColumnIndex = function(a) {
			for (var b = 0; b < this.s[B]; b++) {
				var c = this.s[b];
		...
		N.getColumnLabel = function(a) {
			U(this, a);
			a = this.s[a];return an(a) ? this.h[Qb](a) : a[Id] || J
		};
		N.getColumnPattern = function(a) {
			U(this, a);
			a = this.s[a];return an(a) ? this.h[Tc](a) : k
		};
		N.getColumnRole = function(a) {
			a = this[Qc](a, Bl);return a = R(a) ? a : J
		};
		N.getColumnType = function(a) {
			U(this, a);
			a = this.s[a];return an(a) ? this.h[Ub](a) : a[z]
		};Ga(N, function(a, b) {
			U(this, b);
			var c = this[Zb](a),
				d = this.s[b];
		...
		N.qj = function(a, b) {
			...
			var c = this.s[b],
				d = c.calc;
			R(d) ? (d = wr[d], c = d(this.h, a, c.sourceColumn)) : c = d[G](k, this.h, a);return this.Le[b][a] = c
		};
		N.getFormattedValue = function(a, b) {
			U(this, b);
			var c = this.s[b];
		...
		N.getProperty = function(a, b, c) {
			U(this, b);
			b = this.s[b];return an(b) ? this.h.getProperty(this[Zb](a), b, c) : k
		};
		N.getProperties = function(a, b) {
			U(this, b);
			var c = this.s[b];
		...
		N.getColumnProperties = function(a) {
			U(this, a);
			a = this.s[a];return an(a) ? this.h[Ab](a) : a.properties || {}
		};
		N.getTableProperty = function(a) {
		...
		N.getRowProperties = function(a) {
			Oq(this, a);return this.h[cc](this[Zb](a))
		};
		N.getColumnRange = function(a) {
			return Rq(this, a)
		};
		...
		N.toDataTable = function() {
			...
			var a = xn(a[Hc]()),
				...
				j = [],
				o = [];
			for (d = 0; d < b; d++) h = this.s[d], $m(h) ? (f = wo(h),
				delete f.calc
				,
				delete f.sourceColumn
			...
			for (f = 0; f < c; f++) {
				...
				for (d = 0; d < b; d++) {
					...
					$m(h) ? C = {
						v : this[A](f, d)
					} : an(h) ? C = r.c[this.s[d]] : e(n(og));w[s](C)
				}
				r.c = w;o[s](r)
			}
			a.cols = j;
			a.rows = o;return a = new V(a)
		};
		N.toJSON = function() {
			...
			0 == b[B] || (a.columns = b);this.Xa || (a.rows = ko(this.Wa));return un(a)
		};
		var wr = {
		...
		X.addError = function(a, b, c, d) {
			...
			X.Qi(a, r);c.removeDuplicates && X.Si(a, r);return j
		};
		...
		X.addErrorFromQueryResponse = function(a, b) {
			X.Ne(a) || e(n(X.Me));b || e(n(X.vh + " response is null"));
			...
			Ca(d, b[Nb]() ? Ci : Fm);
			d.removeDuplicates = i;return X[Gc](a, c, f, d)
		};
		X.removeError = function(a) {
			a = ja[lb](a);return X.Cf(a) ? (X.Pe(a), i) : l
		};
		X.getContainer = function(a) {
			a = ja[lb](a);return X.Cf(a) ? a[Hd][Hd] : k
		};
		...
		X.zf = function(a, b) {
			for (var c = a[hc], d = k, f = ip(), h = 0; h < c[B]; h++)
				if (c[h].id && 0 == c[h].id[jd](X.Af, 0)) {
					d = c[h];f.removeNode(d);break
			}
			!d && b && (d = X.Af + X.xg++, d = rp(ti, {
				id : d,
				style : si
			}, k));d && ((c = a[Vb]) ? f.se(d, c) : f[Ya](a, d));return d
		};
		X.Qi = function(a, b) {
			var c = X.zf(a, i);
			Va(c[F], zh);c[Ya](b)
		...
		function Gr(a) {
			P(a) || (a = {});
			this.Ve = Qk;P(a.fill) && this.dj(a.fill);
			this.Ue = 1;P(a.Fg) && this.ej(a.Fg);
			this.Te = Qk;P(a.stroke) && this.gj(a.stroke);
			this.Ye = 1;P(a.kj) && this.Eg(a.kj);
			this.Xe = 1;P(a.Hg) && this.ij(a.Hg);
			this.We = Rl;P(a.jj) && this.hj(a.jj);
			this.Ka = k;
			if (a.Ka) this.Ka = wo(a.Ka), this.Ka.bj = Dr(this.Ka.bj), this.Ka.cj = Dr(this.Ka.cj);
			this.Cd = k;a.pattern && this.fj(a.pattern)
		}
		N = Gr[D];
		Ra(N, function() {
			var a = new Gr;
			...
			a.Cd = this.Cd ? this.Cd[cd]() : k;return a
		});
		N.dj = function(a) {
			this.Ve = Dr(a)
		};
		...
		function Hr(a, b, c, d) {
			this.top = a;Xa(this, b);Ta(this, c);ua(this, d)
		}
		Ra(Hr[D], function() {
		...
		function Ir(a, b, c, d) {
			ua(this, a);
			this.top = b;pa(this, c);Wa(this, d)
		}
		Ra(Ir[D], function() {
		...
		function Mr(a, b, c) {
			var d,
				f = Lo && (Fo || Qo) && $o(nf);
			b instanceof Ln ? (d = b.x, b = b.y) : (d = b, b = c);ua(a[F], Nr(d, f));
			a[F].top = Nr(b, f)
		}
		function Or(a) {
			var b = a[$a]();
		...
		function Qr(a) {
			for (var b = new Hr(0, ea, ea, 0), c = ip(a), d = c.o[ad], f = c.o[uc], h = c.Sj(); a = Pr(a);)
				if ((!T || 0 != a[Jc]) && (!Mo || 0 != a[pd] || a != d) && a != d && a != f && Kr(a, cl) != Dm) {
					...
					j.x += o.x;
					j.y += o.y;
					b.top = q.max(b.top, j.y);Xa(b, q.min(b[Pd], j.x + a[Jc]));Ta(b, q.min(b[ud], j.y + a[pd]));ua(b, q.max(b[y], j.x))
			}
			d = h[qd];
			h = h[xc];ua(b, q.max(b[y], d));
			b.top = q.max(b.top, h);
			c = c.Tj();
		...
		function Rr(a) {
			...
			else if (c[Ib] && !f) b = c[Ib](a), a = c[Ib](j), h.x = b[Eb] - a[Eb], h.y = b[Fb] - a[Fb];else {
				b = a;
				do {
					h.x += b.offsetLeft;
					h.y += b[Jd];b != a && (h.x += b[Yb] || 0, h.y += b[ac] || 0);
					if (Mo && Lr(b) == Gi) {
						h.x += c[ad][qd];
						h.y += c[ad][xc];break
					}
		...
		function Tr(a, b, c) {
			b instanceof Nn ? (c = b[I], b = b[t]) : c == g && e(n("missing height argument"));pa(a[F], Nr(b, i));Wa(a[F], Nr(c, i))
		}
		function Nr(a, b) {
			typeof a == K && (a = (b ? q.round(a) : a) + pl);return a
		}
		function Ur(a) {
			...
			var b = a[F],
				...
				f = b.position;
			Ka(b, Oj);
			b.position = lh;Va(b, ek);
			a = Vr(a);Va(b, c);
			b.position = f;Ka(b, d);return a
		}
		function Vr(a) {
			var b = a.offsetWidth,
				c = a.offsetHeight,
		...
		function es() {
			var a = Sm(Hj);
			P(a) || (a = Wj);var b = Sm(Jj);
			P(b) || (b = mf);return a + cf + b
		}
		function fs(a) {
			var b = Sm(a);
			bn(b) || (b = Sm(Ij + a), bn(b) || (b = k));return b
		}
		;
		function gs() {
		}
		...
		N.rk = function(a) {
			...
			a = this.Ij(a);
			a = this.Ub(a);
			a = this.Zg(a);return this.W(a) ? a : k
		};
		N.e = function(a, b, c) {
		...
		S(ns, gs);
		ns[D].W = function(a) {
			this.$(a);return this.gk(a) || this.hk(a)
		};
		ns[D].gk = function(a) {
			var b = a[rb]();
			if (1 > b || 2 < b) return l;
			var c = i;
			2 == b && (c = c && this.e(a, 0, M));return c = c && this.bf(a, b - 1)
		};
		ns[D].hk = function(a) {
			var b = a[rb](),
				c = a[Dc]();
		...
		ps[D].Ok = function(a) {
			...
			var c = this.e(a, 0, K),
				c = c && this.e(a, 1, K);
			3 == b && (c = c && this.e(a, 2, M));return c && this.tj(a, 0, 1)
		};
		ps[D].Nk = function(a) {
			this.$(a);
			var b = a[rb]();
		...
		rs[D].W = function(a) {
			...
			3 == b && (c = c && this.e(a, 2, M));return c && this.Kg(a)
		};
		rs[D].Ub = function(a) {
			var b = this,
				c = [];
		...
		xs[D].W = function(a) {
			...
			if (2 > b || 4 < b) return l;
			var c = this.e(a, 0, M) && this.e(a, 1, M);
			2 < b && (c = c && this.bf(a, 2)) && 3 < b && (c = c && this.e(a, 3, K));return c && this.Kg(a)
		};
		xs[D].Ub = function(a) {
			var b = this,
				c = [];
		...
		function zs(a) {
			An(a) || (a = a[u](/\d/g, ff), a = a[u](/#{10,}/, oa(11)[Ld](ae)));return a
		}
		function As(a) {
			if (1 != a.Nd()) return k;
			a = a.Ja()[0];return zs(a)
		}
		;
		function Bs(a, b) {
			var c = b || {};
			...
			this.pd = a;
			this.fa = c[a + Vg] || k;
			this.og = c[a + Bg] || k;Qa(this, k);
			this.He = c.dataSourceUrl || k;
			this.h = k;this[hd](c.dataTable);
			this.jb = c.options || {};
			this.Sa = c.state || {};var d = c.packages;
			this.pg = Wm(d) ? d : k;
			this.Ra = c.query || k;
		...
		N.Eh = function(a) {
			...
			a[this.pd + Bg] = this[Kb]() || g;this.mh(a);return un(a)
		};
		N.Yj = function() {
			this.mk();this.lk();
			var a = this.fa,
		...
		function Es(a, b, c) {
			if (c == k) Xm(Ds(a, b)) || (c = b[Pc](Ve), 1 < c[B] && (b = c.pop(), a = Ds(a, c[Ld](Ve))),
				...
				b = b[Pc](Ve);
				a = a || O;!(b[0] in a) && a[Nd] && a[Nd](Am + b[0]);
			...
			if (!this[E] || this[E][Rc] != c || f) {
				...
				co([ sl, Gl, Ci, Xl ], function(a) {
					google[E][jb].addListener(d, a, function(b) {
						a == sl && Qa(h, d);(a == sl || a == Xl) && bn(d[od]) && h[wc](d[od][G](d));google[E][jb].trigger(h, a, b)
					})
				})
			} else
				d = this[E];
		...
		N.sendQuery = function(a, b) {
			var c = typeof b == Ch ? b : l,
				...
				f = this[nd]();
			f && c && d[fc](f);(c = this[yd]()) && d[$c](c);d[Jb](a)
		};
		N.lk = function() {
			var a = this.fa;
			if (!(Cs[a] != di || a == Mg)) {
				...
				if (c != k) {
					...
					a = new google[E][md](a);a[Md](d);Es(b, Kj, k);this[hd](a);this[Vc](b)
				}
			}
		};
		N.hf = function() {
			this[E] && bn(this[E].clearChart) && this[E].clearChart();Qa(this, k)
		};
		function Y(a) {
			Bs[G](this, Sh, a)
		}
		...
		function $(a) {
			...
			this.nc = a.bindings || k;this.yf(a.dashboardType || Wf);this.wf()
		}
		S($, Bs);
		N = $[D];
		N.yd = function(a, b) {
		...
		N.dk = function(a) {
			this.oh(a) || (a = google[E].createWrapper(a));a[hd](k);a[Mc](k);return a
		};
		N.ck = function(a) {
			var b = a.controls,
				c = a.participants;
		...
		N.Ih = function(a) {
			...
			a = this.ik();
			a = !An(b) ? bo(a, b) : -1;-1 == a && e(n("Invalid wrapper name: " + b));return a
		};
		N.oh = function(a) {
			return bn(a[Hc])
		};
		...
		function Hs(a) {
			a = a || {};R(a) && (a = xn(a));return a.controlType ? new google[E].ControlWrapper(a) : a.dashboardType ? new google[E].DashboardWrapper(a) : new google[E].ChartWrapper(a)
		}
		;
		function Is(a) {
		...
		function Js(a, b, c, d, f) {
			this.aa = !!b;a && this.qc(a, d);Ba(this, f != g ? f : this.ua || 0);this.aa && Ba(this, -1 * this[gc]);
			this.Hd = !c
		}
		S(Js, Kp);
		N = Js[D];
		...
		N.Zj = function() {
			...
			if (this.Oe) {
				...
				if (this.ua == b) {
					...
					(c = this.aa ? a.previousSibling : a[oc]) ? this.qc(c) : this.qc(a[Hd], -1 * b);
				Ba(this, this[gc] + this.ua * (this.aa ? -1 : 1))
			} else
				this.Oe = i;
			(a = this.sa) || e(Jp);return a
		});
		N.yj = function() {
			return 1 == this.ua
		};
		N.splice = function(a) {
			var b = this.sa;
			this.Zj();
			this.aa = !this.aa;Js[D].next[G](this);
			this.aa = !this.aa;
		...
		function Ls(a, b, c, d, f) {
			...
			if (a) {
				...
				this.M = d;
				if (1 == a[ib] && a[Cd] != Lf)
					if (a = a[hc], b = a[b]) this.I = b, this.N = 0;else {
						if (a[B])
							this.I = a[a[B] - 1];
						h = i
				}
		...
		N.oj = function() {
			...
			this.oj() && e(Jp);return Ls.b.next[G](this)
		});
		N.ue = function(a) {
			this.I = a.I;
			this.C = a.C;
		...
		function Qs(a, b, c, d) {
			...
			f[Bc](a, b);f[yb](c, d);return f
		}
		N = Ns[D];Ra(N, function() {
		...
		N.Td = function(a) {
			a.removeAllRanges();a.addRange(this.q)
		};
		...
		function Ts(a) {
			...
			if (1 == a[ib]) b.moveToElementText(a), Ps(a) && !a[hc][B] && b[gb](l);else {
				...
				d || b.moveToElementText(a[Hd]);b[gb](!d);c && b.move(Rh, c);b.moveEnd(Rh, a[B])
			}
			return b
		}
		function Us(a, b, c, d) {
			...
			var f = a,
				...
				o = d,
				r = l;
			1 == f[ib] && (h = f[hc][h], r = !h, f = h || f[fd] || f, h = 0);var w = Ts(f);
			h && w.move(Rh, h);
			...
			for (var d = 1 == a, f = 0, h = c[hc][B]; f < h; f++) {
				...
				if (this[Za]())
					if (Ps(o)) {
						...
						if (0 == this.ka(C, 1, 1)) {
							this.N = this.M = j;break
						}
				}else {
					if (this.Bg(r)) {
						if (!Ps(o)) {
							d ? this.N = j : this.M = j + 1;break
						}
						return this.Ec(a, o)
					}
		...
		N.Sg = function(a, b) {
			...
			f = this.q.duplicate();
			h = Ts(d);f.setEndPoint(c ? Zf : Pg, h);
			f = f.text[B];return c ? d[B] - f : f
		};
		N.isCollapsed = function() {
		...
		S(Ws, Ns);
		Ws[D].Td = function(a) {
			a[gb](this.ma(), this.Ya());(this.La() != this.ma() || this.ob() != this.Ya()) && a.extend(this.La(), this.ob());0 == a.rangeCount && a.addRange(this.q)
		};
		function Xs(a) {
			this.q = a
		}
		...
		function Vs(a) {
			if (T && !bp(9)) {
				...
				a = Mo ? new Xs(Os(a)) : Lo ? new Rs(Os(a)) : Ko ? new Ws(Os(a)) : new Ns(Os(a));
			return a
		}
		function Ps(a) {
			var b;
		...
		N.X = function(a, b, c, d, f) {
			if (Q(b))
				for (var h = 0; h < b[B]; h++) this.X(a, b[h], c, d, f);else {
				a:{
				c = c || this;
				f = f || this.Pg || this;
				d = !!d;
		...
		N.removeAll = function() {
			co(this.D, mq);Ma(this.D, 0)
		};
		N.k = function() {
			bt.b.k[G](this);this[id]()
		};za(N, function() {
		...
		function dt(a, b, c) {
			...
			this.o = kp(a);
			this.Ca = new bt(this);hq(this.handle, [ om, Gk ], this.ag, l, this)
		}
		S(dt, sq);
		var et = T || Lo && $o("1.9.3");
		N = dt[D];Ha(N, 0);Ia(N, 0);va(N, 0);wa(N, 0);
		N.sg = 0;
		N.tg = 0;
		N.ic = 0;
		N.jc = 0;
		...
		N.k = function() {
			dt.b.k[G](this);kq(this.handle, [ om, Gk ], this.ag, l, this);this.Ca.Q();
			delete this[ed];
			delete this.handle;
			delete this.Ca
		};
		N.ag = function(a) {
			...
			if (this.vb && !this.kb && (!b || a.ne())) {
				this.Be(a);
				if (0 == this.qg)
					if (this.rg(a), this.kb) a[ub]();else return;
				else a[ub]();
				this.Ki();Ha(this, this.sg = a[sc]);Ia(this, this.tg = a[tc]);va(this, a[Eb]);wa(this, a[Fb]);
		...
		N.Ki = function() {
			var a = this.o,
				b = a[uc],
				c = !et;
			this.Ca.i(a, [ nm, Hk ], this.Ti, c);this.Ca.i(a, [ mm, Kk ], this.sd, c);
			et ? (b.setCapture(l), this.Ca.i(b, vk, this.sd)) : this.Ca.i(qp(a), Ah, this.sd);T && this.Ui && this.Ca.i(a, vi, Zp);this.Wi && this.Ca.i(this.Wi, Fl, this.Vi, c)
		};
		N.rg = function(a) {
		...
		N.sd = function(a, b) {
			this.Ca[id]();et && this.o.releaseCapture();
		...
		N.Ti = function(a) {
			if (this.vb) {
				...
				var b = a[sc] - this[sc],
					c = a[tc] - this[tc];
				Ha(this, a[sc]);Ia(this, a[tc]);va(this, a[Eb]);wa(this, a[Fb]);
				if (!this.kb) {
				...
				c = this.Tg(b, c);
				b = c.x;
				c = c.y;this.kb && this[x](new ft(wh, this, a[sc], a[tc], a, b, c)) !== l && (this.Ug(a, b, c, l), a[ub]())
			}
		};
		N.Tg = function(a, b) {
			var c = ip(this.o).ac(),
		...
		N.Vi = function(a) {
			var b = this.Tg(0, 0);
			Ha(a, this[sc]);Ia(a, this[tc]);this.Ug(a, b.x, b.y, i)
		};
		N.Ug = function(a, b, c) {
			this.Tk(b, c);this[x](new ft(ui, this, a[sc], a[tc], a, b, c))
		};
		N.zg = function(a) {
			var b = this.lf,
				c = !la(b[y]) ? b[y] : k,
		...
		function ft(a, b, c, d, f, h, j, o) {
			Yp[G](this, a);Ha(this, c);Ia(this, d);
			this.kl = f;ua(this, Wm(h) ? h : b.ic);
		...
		S(gt, sq);za(gt[D], function(a) {
			var b = new $p(a.Y);
			Ca(b, a[z] == Ii || a[z] == Hi ? Ii : Ji);try {
				this[x](b)
			} finally {
				b.Q()
			}
		...
		gt[D].k = function() {
			gt.b.k[G](this);mq(this.ni);mq(this.oi);
			delete this.j
		};
		function ht() {
		}
		...
		function kt(a, b) {
			switch (a) {
			case 1:
				return b ? pi : zi;case 2:
				return b ? Qj : vm;case 4:
				return b ? nh : ji;case 8:
				return b ? Gl : wm;case 16:
				return b ? Th : um;case 32:
				return b ? Hi : Ah;case 64:
				return b ? Xk : Yh
			}
		...
		N.$d = function(a) {
			this == a && e(n(Wg));a && this.Aa && this.Ad && this.Aa.ce(this.Ad) && this.Aa != a && e(n(Wg));
			this.Aa = a;it.b.Qe[G](this, a)
		};
		N.getParent = function() {
			return this.Aa
		};
		N.Qe = function(a) {
			this.Aa && this.Aa != a && e(n("Method not supported"));it.b.Qe[G](this, a)
		};
		N.t = function() {
			return this.fb
		};
		...
		N.Sf = function(a, b) {
			this.r && e(n(Tf));this.j || this.d();
			a ? a[vb](this.j, b || k) : this.fb.o[ad][Ya](this.j);(!this.Aa || this.Aa.r) && this.K()
		};
		N.K = function() {
			this.r = i;this.rb(function(a) {
				!a.r && a.a() && a.K()
			})
		};
		N.ba = function() {
		...
		N.k = function() {
			it.b.k[G](this);this.r && this.ba();this.bc && (this.bc.Q(),
			delete this.bc
			);this.rb(function(a) {
				a.Q()
		...
		N.Cc = function(a, b, c) {
			a.r && (c || !this.r) && e(n(Tf));(0 > b || b > this.ab()) && e(n("Child component index out of bounds"));
		...
		N.removeChild = function(a, b) {
			...
			a || e(n("Child is not in parent component"));return a
		};
		N.Qk = function(a, b) {
		...
		N.d = function() {
			lt.b.d[G](this);
			var a = this.a();
			gp(a, this.A());Gp(a, i);Yr(a, l);this.ei();this.di()
		};
		N.ei = function() {
		...
		N.Xh = function() {
			this.V && yp(this.V, this.a());yp(this.ca, this.a())
		};
		N.K = function() {
			this.Xh();lt.b.K[G](this);
			var a = this.a();
			a[Hd] && a[Hd][vb](this.ya, a[oc]);
			this.ae = new gt(this.t().o);this.P().i(this.ae, Ii, this.Wh)
		};
		N.ba = function() {
			this.n && this.F(l);Tp(this.ae);lt.b.ba[G](this);zp(this.V);zp(this.ca);zp(this.ya)
		};
		N.F = function(a) {
		...
		N.hg = function(a) {
			this.V && Yr(this.V, a);this.ca && Yr(this.ca, a);Yr(this.a(), a);Yr(this.ya, a)
		};
		N.focus = function() {
			this.th()
		};
		N.ye = function() {
			this.V && Yr(this.V, l);this.ca && Yr(this.ca, l);
			var a = this.t().o,
				b = op(qp(a) || ba || ba),
				c = q.max(a[ad].scrollWidth, b[t]),
				a = q.max(a[ad][Sb], b[I]);
			this.V && (Yr(this.V, i), Tr(this.V, c, a));this.ca && (Yr(this.ca, i), Tr(this.ca, c, a))
		};
		N.vc = function() {
			var a = this.t().o,
				b = qp(a) || ba;
		...
		N.A = function() {
			...
			this.na = a;this.tc && qa(this.tc, a)
		});
		N.zd = function() {
			this.a() || this.ub()
		};
		N.S = function() {
			this.zd();return this.tc
		};
		N.$i = function() {
			this.zd();return this.Pc
		};
		N.Zi = function() {
			this.zd();return this.Ma
		};
		N.Yc = function() {
			this.zd();return mt.b.Yc[G](this)
		};
		N.Uh = function(a) {
			this.be = a;this.a() && (a = this.Yc()) && Xr(a, this.be)
		};
		N.bi = function(a) {
			this.Nf = a;
			if (this.r) {
		...
		N.d = function() {
			...
			this.Zb = b.d(ti, {
				...
				id : this.Vb()
			}, this.Pc = b.d(Ul, this.za + Te, this.Vh), this.Oc = b.d(Ul, this.za + Re));wp(a, this.Zb, this.tc = b.d(ti, this.za + Ce), this.Ma = b.d(ti, this.za + ye));
			this.Pf = this.Zb.id;Ys(a, mi);Zs(a, qk, this.Pf || J);this.na && qa(this.tc, this.na);Yr(this.Oc, this.Mf);this.cb && this.cb.Th(this.Ma);Yr(this.Ma, !!this.cb);this.Uh(this.be)
		};
		N.K = function() {
			mt.b.K[G](this);this.P().i(this, [ Ql, Pj ], this.ci);this.Qf(this.$h);this.P().i(this.Oc, Xh, this.ai);Ys(this.a(), mi);this.Pc.id !== J && Zs(this.a(), qk, this.Pc.id);this.Nf || this.bi(l)
		};
		N.ba = function() {
			this.n && this.F(l);this.Qf(l);mt.b.ba[G](this)
		};
		N.F = function(a) {
					...
					for (var b = this.t().o, c = this.Ma[rc](Oh), d = 0, f; f = c[d]; d++)
						if (f[nc] == a) {
							try {
								if (Mo || Ko) {
									var h = b[Pb](gk);
									h[F].cssText = ll;this.a()[Ya](h);h[Ob]();this.a()[bd](h)
								}
								f[Ob]()
							} catch (j) {} break
				}
		...
		N.k = function() {
			this.Ma = this.Oc = k;mt.b.k[G](this)
		};
		N.Xf = function(a) {
		...
		N.ub = function() {
			if (this.j) {
				...
				Mp(this, function(b, c) {
					...
					c == this.Sc && Oa(d, this.za + De);this.j[Ya](d)
				}, this)
			}
		};
		N.a = function() {
		...
		N.k = function() {
			wt.b.k[G](this);this.detach()
		};
		function Bt(a, b, c, d) {
			d && this.Pb(d, g);Ca(this, lk);ya(this, a);
			this.charCode = b;
			this.repeat = c
		}
		S(Bt, $p);
		...
		N.Wb = function(a) {
			a.le() && this.dc(a.a(), i);a[gd]() && this.Ab(a, a.n)
		};
		N.li = function(a, b) {
			var c = b || this.nb();
			c && Ys(a, c)
		...
		N.Je = function(a, b) {
			a[gd]() || this.da(b, 1, i);a.Wg() && this.da(b, 8, i);a.T(16) && this.da(b, 16, a.ke());a.T(64) && this.da(b, 64, a.cc())
		};
		N.$c = function(a, b) {
			$r(a, !b, !T && !Ko)
		};
		...
		N.hc = function(a) {
			var b = this.A(),
				...
				d = this.oc();
			d != b && c[s](d);
			b = this.Fj(a[od]());c[s][Ad](c, b);(a = a.Ea) && c[s][Ad](c, a);T && !$o(sf) && c[s][Ad](c, this.kg(c));return c
		};
		N.kg = function(a, b) {
			var c = [];
			b && (a = a[ob]([ b ]));co([], function(d) {
		...
		N.kd = function(a) {
			this.uh || this.Hk();return this.uh[a]
		};
		N.Hk = function() {
			var a = this.oc();
			this.uh = {
		...
		function Et(a, b) {
			a || e(n("Invalid class name " + a));bn(b) || e(n("Invalid decorator function " + b))
		}
		var Ft = {};
		function Gt(a, b, c) {
			it[G](this, c);
		...
		N.d = function() {
			var a = this.l.d(this);
			this.dg(a);this.l.li(a, this.fg);this.ee || this.l.$c(a, l);this.n || this.l.F(a, l)
		};
		N.Hh = function(a) {
			this.fg = a
		};
		...
		N.K = function() {
			Gt.b.K[G](this);this.l.Wb(this);
			if (this.uc & -2 && (this.de && this.Rf(i), this.T(32))) {
				var a = this.R();
				if (a) {
					var b = this.Wc();
					b.Tf(a);this.P().i(b, lk, this.wa).i(a, Hi, this.Xc).i(a, Ah, this.yb)
				}
			}
		};
		N.Rf = function(a) {
		...
		N.ba = function() {
			Gt.b.ba[G](this);this.ia && this.ia.detach();this.n && this[gd]() && this.l.Ab(this, l)
		};
		N.k = function() {
			Gt.b.k[G](this);this.ia && (this.ia.Q(),
			delete this.ia
			);
			delete this.l;
			this.Ea = this.na = k
		};Fa(N, function(a) {
			this.l[mc](this.a(), a);this.Zf(a)
		});
		N.Zf = function(a) {
			this.na = a
		};
		N.wc = function() {
			...
			if (!R(a))
				if (Q(a))
					...
					a = a[u](/\u200B/g, J);ep || (a = a[u](/ +/g, Sd));a != Sd && (a = a[u](/^\s*/, J))
			}
			return Bn(a)
		};
		N.dc = function(a) {
		...
		N.F = function(a, b) {
			if (b || this.n != a && this[x](a ? Ql : Pj)) {
				var c = this.a();
				c && this.l.F(c, a);this[gd]() && this.l.Ab(this, a);
				this.n = a;return i
			}
			return l
		};
		...
		N.pa = function(a, b) {
			this.r && this.oa(a) && !b && e(n(Tf));!b && this.oa(a) && this[wc](a, l);
		...
		N.tb = function(a) {
			this[gd]() && (this.ea(2) && this.xa(i), a.ne() && (this.ea(4) && this[qc](i), this.l.sb(this) && this.R()[Ob]()));!this.ee && a.ne() && a[ub]()
		};
		N.zb = function(a) {
		...
		N.Bb = function(a) {
			this.ea(16) && this.zj(!this.ke());this.ea(8) && this.gf(i);this.ea(64) && this.H(!this.cc());
		...
		N.yb = function() {
			this.ea(4) && this[qc](l);this.ea(32) && this.ph(l)
		};
		N.wa = function(a) {
		...
		};bn(Gt) || e(n("Invalid component class " + Gt));bn(Ct) || e(n("Invalid renderer class " + Ct));
		var Ht = cn(Gt);
		Ft[Ht] = Ct;Et(nj, function() {
			return new Gt(k)
		});
		function It() {
			this.wh = []
		...
		N.d = function(a) {
			...
			this.Ai(a, b, a.T(8) || a.T(16));return b
		};
		N.S = function(a) {
			return a && a[Vb]
		};Fa(N, function(a, b) {
			var c = this.S(a),
				d = this.re(a) ? c[Vb] : k;
			It.b[mc][G](this, a, b);d && !this.re(a) && c[vb](d, c[Vb] || k)
		});
		N.zi = function(a, b) {
			var c = this.fd(2);
			return b.d(ti, c, a)
		...
		N.Ai = function(a, b, c) {
			if (c != this.re(b))
				if (c ? gp(b, yj) : hp(b, yj), b = this.S(b), c) c = this.fd(1), b[vb](a.t().d(ti, c), b[Vb] || k);else b[bd](b[Vb])
		};
		N.kd = function(a) {
			switch (a) {
			case 2:
				return this.fd(0);case 16:
			case 8:
				return zj;default:
		...
		function Jt(a, b, c, d) {
			Gt[G](this, a, d || It.qa(), c);this[Ic](b)
		}
		S(Jt, Gt);
		N = Jt[D];Ga(N, function() {
			var a = this.je;
		...
		function Kt(a, b, c, d, f, h, j, o) {
			...
			w = Wr(a);(C = Qr(a)) && w.Ng(new Ir(C[y], C.top, C[Pd] - C[y], C[ud] - C.top));var C = ip(a),
				L = ip(c);
			if (C.o != L.o) {
				var ta = C.o[ad],
					L = L.ed(),
				...
				do {
					...
					if (db == L)
						...
						Ja = new Ln;
						if (1 == ma[ib])
							if (ma[$a]) ma = Or(ma), Ja.x = ma[y], Ja.y = ma.top;else {
								var ra = ip(ma).ac(),
									ma = Rr(ma);
								Ja.x = ma.x - ra.x;
								Ja.y = ma.y - ra.y
				...
				ta = Mn(ia, Rr(ta));T && !C.ff() && (ta = Mn(ta, C.ac()));ua(w, w[y] + ta.x);
				w.top += ta.y
			}
			a = (b & 4 && Sr(a) ? b ^ 2 : b) & -5;
			b = new Ln(a & 2 ? w[y] + w[t] : w[y], a & 1 ? w.top + w[I] : w.top);r && (b = Mn(b, r));f && (b.x += (a & 2 ? -1 : 1) * f.x, b.y += (a & 1 ? -1 : 1) * f.y);var H;
		...
		N.d = function(a) {
			var b = Ut.b.d[G](this, a),
				c = a.ad();
			c && this.fe(b, c);(c = a[A]()) && this[Ic](b, c);a.T(16) && this.da(b, 16, a.ke());return b
		};Ga(N, Tm);Na(N, Tm);
		N.ad = function(a) {
			return a.title
		};
		...
		N.da = Tm;
		N.Li = function(a) {
			a.ie(l);a.nk(255, l);a.pa(32, l)
		};
		function Wt(a, b, c) {
			Gt[G](this, a, b || Vt.qa(), c)
		}
		S(Wt, Gt);
		N = Wt[D];Ga(N, function() {
			return this.Wf
		});Na(N, function(a) {
			this.Wf = a;this.l[Ic](this.a(), a)
		});
		N.ad = function() {
			return this.Vf
		};
		N.fe = function(a) {
			this.Vf = a;this.l.fe(this.a(), a)
		};
		N.k = function() {
			Wt.b.k[G](this);
			delete this.Wf;
		...
		function Yt(a, b) {
			Gt[G](this, k, a || Xt.qa(), b);this.pa(1, l);this.pa(2, l);this.pa(4, l);this.pa(32, l);this.jh(1)
		}
		S(Yt, Gt);
		Yt[D].K = function() {
			Yt.b.K[G](this);Ys(this.a(), Il)
		};Et(wj, function() {
			return new Yt
		});
		function Zt() {
		...
		N.K = function() {
			$t.b.K[G](this);this.rb(function(a) {
				a.r && this.Kf(a)
			}, this);
			var a = this.a();
			this.l.Wb(this);this.F(this.n, i);this.P().i(this, Bi, this.Xd).i(this, Qj, this.Yd).i(this, vm, this.Zd).i(this, Xk, this.Ph).i(this, Yh, this.Nh).i(a, Gk, this.tb).i(kp(a), Kk, this.Oh).i(a, [ Gk, Kk, Jk, Ik ], this.Mh);this.sb() && this.Lf(i)
		};
		N.Lf = function(a) {
			var b = this.P(),
				c = this.R();
		...
		N.ba = function() {
			this.Yb(-1);this.L && this.L.H(l);
			this.ge = l;$t.b.ba[G](this)
		};
		N.k = function() {
			$t.b.k[G](this);
		...
		N.Yd = function(a) {
			...
			if (-1 < b && b != this.ha) {
				...
				c && c.xa(l);
				this.ha = b;
				c = this.$b();this.ge && c[qc](i);this.ki && this.L && c != this.L && (c.T(64) ? c.H(i) : this.L.H(l))
			}
		...
		N.Xc = function() {};
		N.yb = function() {
			this.Yb(-1);this.Xb(l);this.L && this.L.H(l)
		};
		N.wa = function(a) {
		...
		N.Ba = function(a) {
			...
			case 27:
				...
				break;case 37:
				if (this.gc == Rj)
					this.le() ? this.Re() : this.Se();else return l;
				break;case 40:
		...
		N.Cc = function(a, b, c) {
			a.gg(2, i);a.gg(64, i);(this.sb() || !this.mi) && a.pa(32, l);a.ie(l);$t.b.Cc[G](this, a, b, c);a.r && this.r && this.Kf(a);b <= this.ha && this.ha++
		};
		N.removeChild = function(a, b) {
			if (a = R(a) ? this.ce(a) : a) {
				var c = this.Vc(a);
				-1 != c && (c == this.ha ? a.xa(l) : c < this.ha && this.ha--);(c = a.a()) && c.id && this.Oa && vo(this.Oa, c.id)
			}
			a = $t.b[bd][G](this, a, b);a.ie(i);return a
		};
		N.F = function(a, b) {
			if (b || this.n != a && this[x](a ? Ql : Pj)) {
				this.n = a;
				var c = this.a();
				c && (Yr(c, a), this.sb() && this.l.Yf(this.R(), this.vb && this.n), b || this[x](this.n ? qh : ph));return i
			}
			return l
		};
		N.isEnabled = function() {
		...
		N.Ab = function(a) {
			...
			this.Fe = a;this.vb && this.n && this.l.Yf(this.R(), a)
		};
		N.Yb = function(a) {
		...
		function bu(a, b, c) {
			Gt[G](this, a, c || au.qa(), b);this.pa(1, l);this.pa(2, l);this.pa(4, l);this.pa(32, l);this.jh(1)
		}
		S(bu, Gt);Et(sj, function() {
			return new bu(k)
		});
		function cu() {
		}
		...
		cu[D].Wb = function(a) {
			cu.b.Wb[G](this, a);Zs(a.a(), Lj, sm)
		};Et(wj, function() {
			return new Yt
		});
		function du(a, b) {
			$t[G](this, Cm, b || cu.qa(), a);this.Ab(l)
		}
		S(du, $t);
		N = du[D];
		N.we = i;
		...
		N.qc = function(a, b) {
			...
			Mr(d, d.offsetLeft + (f - j.x), d[Jd] + (h - j.y));c || Yr(this.a(), l)
		};
		N.si = function(a) {
			(this.we = a) && this.Ab(i)
		};
		N.F = function(a, b, c) {
			...
			this.eg = a && c && an(c[sc]) ? new Ln(c[sc], c[tc]) : k;return b
		};
		N.Xd = function(a) {
			this.we && this.R()[Ob]();return du.b.Xd[G](this, a)
		};
		N.Vg = function(a) {
		...
		N.Je = function(a, b) {
			a[gd]() || this.da(b, 1, i);a.Wg() && this.da(b, 8, i);a.T(16) && this.da(b, 16, i);a.cc() && this.da(b, 64, i)
		};
		N.S = function(a) {
			return a && a[Vb][Vb]
		};
		...
		S(fu, eu);Um(fu);Lo && Fa(fu[D], function(a, b) {
		...
		N = fu[D];
		N.S = function(a) {
			a = fu.b.S[G](this, a && a[Vb]);Lo && a && a.__goog_wrapper_div && (a = a[Vb]);return a
		};
		N.createButton = function(a, b) {
		...
		function gu(a, b, c, d) {
			Wt[G](this, a, c || fu.qa(), d);this.pa(64, i);b && this.Zc(b);
			this.Zh = k;
			this.ga = new tq(500);(St || Tt) && !$o(rf) && this.Gj(i)
		}
		S(gu, Wt);
		N = gu[D];
		N.gi = i;
		...
		N.Sh = l;
		N.K = function() {
			gu.b.K[G](this);this.g && this.Uc(this.g, i);Zs(this.a(), Lj, sm)
		};
		N.ba = function() {
			gu.b.ba[G](this);
			if (this.g) {
				this.H(l);this.g.ba();this.Uc(this.g, l);
				var a = this.g.a();
				a && zp(a)
			}
		};
		N.k = function() {
			gu.b.k[G](this);this.g && (this.g.Q(),
			delete this.g
			);
			delete this.Qh;
			this.ga.Q()
		...
		N.tb = function(a) {
			gu.b.tb[G](this, a);this.Da() && (this.H(!this.cc(), a), this.g && this.g.Xb(this.cc()))
		};
		N.zb = function(a) {
			gu.b.zb[G](this, a);this.g && !this.Da() && this.g.Xb(l)
		};
		N.Bb = function() {
			this[qc](l);return i
		};
		...
		N.yb = function(a) {
			this.Tc || this.H(l);gu.b.yb[G](this, a)
		};
		N.Ac = function() {
			this.g || this.Zc(new du(this.t()));return this.g || k
		};
		N.Zc = function(a) {
			var b = this.g;
			if (a != b && (b && (this.H(l), this.r && this.Uc(b, l),
				delete this.g
				), a)) this.g = a, a.$d(this), a.F(l), a.si(this.Tc), this.r && this.Uc(a, i);
			return b
		};
		N.gb = function(a) {
			this.Ac().Dd(a, i)
		...
		N.H = function(a, b) {
			...
			if (this.g && this.oa(64) == a) {
				...
				this.g.F(a, l, b);this.Rc || this.Rh(a)
			}
		};
		N.Of = function() {
			if (this.g.r) {
				...
				a = this.g.a();this.g.n || (Ka(a[F], Oj), Yr(a, i));
				if (!this.Qc && this.me)
					this.Qc = Ur(a);
				b.vc(a, b.bd ^ 1, this.Zh, this.Qc);this.g.n || (Yr(a, l), Ka(a[F], Dm))
			}
		};
		N.ji = function() {
			var a = Wr(this.a()),
		...
		N.Uc = function(a, b) {
			var c = this.P(),
				d = b ? c.i : c.X;
			d[G](c, a, mh, this.ve);d[G](c, a, Qj, this.Yd);d[G](c, a, vm, this.Zd)
		};
		N.Yd = function(a) {
			Zs(this.a(), oh, a[ed].a().id)
		};
		...
		N.Rh = function(a) {
			var b = this.P(),
				c = a ? b.i : b.X;
			c[G](b, this.t().o, Gk, this.hi, i);this.Tc && c[G](b, this.g, Ah, this.ii);c[G](b, this.ga, hm, this.ji);
		...
		function iu(a, b, c, d) {
			gu[G](this, a, b, c, d);this.Lk(a);this.Hh(uk)
		}
		S(iu, gu);
		N = iu[D];
		N.w = k;
		N.te = k;
		N.K = function() {
			iu.b.K[G](this);this.oe();this.Uf();Zs(this.a(), Lj, Ei)
		};
		N.k = function() {
			iu.b.k[G](this);
		...
		N.ve = function(a) {
			this.Qb(a[ed]);iu.b.ve[G](this, a);a[Sc]();this[x](mh)
		};
		N.lj = function() {
			var a = this.wd();
			iu.b[Ic][G](this, a && a[A]());this.oe()
		};
		N.Zc = function(a) {
			var b = iu.b.Zc[G](this, a);
			a != b && (this.w && this.w.clear(), a && (this.w ? a.rb(function(a) {
				this.rd(a);this.w.gb(a)
			}, this) : this.ze(a)));return b
		};
		N.Lk = function(a) {
			this.te = a;this.oe()
		};
		N.gb = function(a) {
			this.rd(a);iu.b.gb[G](this, a);
			this.w ? this.w.gb(a) : this.ze(this.Ac())
		};
		N.mc = function(a, b) {
			this.rd(a);iu.b.mc[G](this, a, b);
		...
		N.ze = function(a) {
			this.w = new hu;a && a.rb(function(a) {
				this.rd(a);this.w.gb(a)
			}, this);this.Uf()
		};
		N.Uf = function() {
		...
		N.H = function(a, b) {
			iu.b.H[G](this, a, b);this.cc() && this.Ac().Yb(this.qd())
		...
		function ju(a, b) {
			...
			for (var c = es() + ef, d = ja[rc](sg), f = 0; f < d[B]; f++)
				if (d[f] && d[f][wd] && d[f][wd] == c) break a;
			d = ja[Pb](tk);
			d.href = c;
			d.rel = am;Ca(d, em);
			if (0 == ja[rc](Mj)[B]) {
		...
		function ku(a, b) {
			...
			switch (a) {
			case 2:
				d = new mt(Fj);h = rl + d.Vb();f = c.d(ti, k, c.d(ti, {
					"class" : Ej
				}, Vf), c.d(Nh, k), c.d(ml, k, c.d(ti, {
					id : h
				}, b[Xc])));
				break;case 3:
				d = new mt(Aj);f = c.d(ti, k, c.d(ti, {
					"class" : Ej
				}, Vf), c.d(Nh, k));var j = c.d(ti, k, c.d(ml, k, b[Xc]));
				c[Ya](f, j)
			}
			d[mc](f.innerHTML);qa(d.$i(), eg);qa(d.Zi(), J);d.F(i);h && (c = lp(h), (T && !bp(9) ? Us(c, 0, c, 1) : Mo ? new Xs(Qs(c, 0, c, 1)) : Lo ? new Rs(Qs(c, 0, c, 1)) : Ko ? new Ws(Qs(c, 0, c, 1)) : new Ns(Qs(c, 0, c, 1))).select())
		}
		N.fk = function(a) {
			var a = a || [],
				b = this.ec,
				c = this.fb;
			c.vg(b);b || e(n("Container is not defined"));
			var d = c.d(Ul, k),
			...
			hq(this.lc, mh, jn(this.Ii, this));this.lc.ub(d);c[Ya](b, d)
		};
		N.ok = function() {
			this.lc.xh(-1)
		};
		N.Ii = function() {
			this.bh[this.lc.qd()]();this.ok()
		};
		N.Gc = function(a, b, c) {
			c = new Jt(c);
			this.bh[a] = b;return c
		};
		function lu(a) {
			if (!a) return J;
			var b = J,
		...
		;m("google.visualization.drawChart", Gs);m("google.visualization.drawFromUrl", function(a, b) {
		...
		p($[D], "getDashboardName", $[D].getDashboardName);p($[D], Wi, $[D][td]);p($[D], dj, $[D][sd]);p($[D], ej, $[D][yd]);p($[D], fj, $[D][nd]);p($[D], "getView", $[D][Cc]);p($[D], "getWrappers", $[D].getWrappers);p($[D], "setBindings", $[D].setBindings);p($[D], Kl, $[D][Mc]);p($[D], Ll, $[D][hd]);p($[D], "setDashboardName", $[D].setDashboardName);p($[D], Jl, $[D].setContainerId);p($[D], Nl, $[D].setPackages);p($[D], Ol, $[D][$c]);p($[D], Pl, $[D][fc]);p($[D], "setView", $[D][Zc]);p($[D], ij, $[D].getSnapshot);p($[D], "setWrappers", $[D].setWrappers);m("google.visualization.drawToolbar", function(a, b) {
			new ju(a, b)
		...
		m("google.visualization.data.join", function(a, b, c, d, f, h) {
			...
			co(d, function(c) {
				...
				f = r[Dd](d, a[Qb](c[0]));r[Db](f, a[Ab](c[0]));w[s](d)
			});
			var C = [],
				L = [];
			co(d, function(a) {
			...
			for (var db = l, Da = 0, Ja = 0, ma = 0; Da < ta[B] || Ja < ia[B];) {
				var ra = 0,
					Aa = [];
				if (Ja >= ia[B])
					if (j) Aa[0] = ta[Da], ra = -1;else break;
				else if (Da >= ta[B])
					if (o) Aa[1] = ia[Ja], ra = 1;else break;else {
					Aa[0] = ta[Da];
					Aa[1] = ia[Ja];
					for (var H = 0; H < d[B]; H++) {
				...
				if (db && 0 != ra) db = l, Ja++;else {
					if (-1 == ra && j || 1 == ra && o || 0 == ra) {
						...
						var Oe,
							ec;
						-1 == ra && j || 0 == ra && c != Al ? (Oe = a, ec = 0) : (Oe = b, ec = 1);co(d, function(a, b) {
		...
		p(V[D], "setTableProperties", V[D].setTableProperties);p(V[D], "setTableProperty", V[D].setTableProperty);p(V[D], "setValue", V[D][Ic]);p(V[D], "sort", V[D].sort);p(V[D], km, V[D][Hc]);m("google.visualization.DataView", W);p(W, "fromJSON", function(a, b) {
			R(b) && (b = xn(b));
			var c = new W(a),
				d = b.columns,
				f = b[zd];
			P(d) && c[Md](d);P(f) && c.setRows(f);return c
		});p(W[D], "getColumnId", W[D].getColumnId);p(W[D], Qi, W[D].getColumnIndex);p(W[D], Ri, W[D][Qb]);p(W[D], Si, W[D][Tc]);p(W[D], Ui, W[D][Qc]);p(W[D], Ui, W[D][Qc]);p(W[D], Ti, W[D][Ab]);
		...
		m("google.visualization.arrayToDataTable", function(a, b) {
			...
			for (f = 0; f < j; f++) {
				...
				for (d = 0; d < r[B]; d++)
					if (h = r[d][f], P(h)) {
						R(h) ? C = M : an(h) ? C = K : Q(h) ? C = im : typeof h == Ch ? C = Ch : (Zm(h) && e(n("Date and datetime column types are not supported")), e(n("Invalid value in " + d + ue + f)));break
				}
				w[f] = C
			}
	...
	(function() {
		...
		function up(a, b, c) {
			...
			if (2 < arguments[I]) {
				...
				return function() {
					...
					ma[K].unshift[Uc](c, d);return a[Uc](b, c)
				}
			}
			return function() {
		...
		function Z(a, b, c) {
			Z = Function[K].bind && -1 != Function[K].bind[ac]()[sb](bl) ? tp : up;return Z[Uc](l, arguments)
		}
		function vp(a, b) {
			var c = ma[K][ab][N](arguments, 1);
			return function() {
				var b = ma[K][ab][N](arguments);
				b.unshift[Uc](b, c);return a[Uc](this, b)
			}
		}
		...
		function zp(a, b) {
			...
			if (!Ep[Za](a)) return a;
			-1 != a[sb](Zd) && (a = a[bb](Ap, $d));-1 != a[sb](Ze) && (a = a[bb](Bp, be));-1 != a[sb](mf) && (a = a[bb](Cp, ae));-1 != a[sb](td) && (a = a[bb](Dp, ce));return a
		}
		var Ap = /&/g,
			Bp = /</g,
			Cp = />/g,
		...
		function Rp(a, b, c) {
			b = Tp(a, b, c);return 0 > b ? l : np(a) ? a[ib](b) : a[b]
		}
		function Tp(a, b, c) {
			for (var d = a[I], e = np(a) ? a[qc](S) : a, f = 0; f < d; f++)
		...
		function Up(a, b, c) {
			...
			b = -1}return 0 > b ? l : np(a) ? a[ib](b) : a[b]
		}
		function Vp(a) {
			if (!jp(a))
		...
		V = lq[K];Oa(V, function() {
			return new lq(this[w], this[Q])
		});
		V.pb = function() {
			return this[w] * this[Q]
		};sa(V, function() {
			oa(this, s[db](this[w]));Ua(this, s[db](this[Q]));return this
		});ta(V, function() {
			oa(this, s[B](this[w]));Ua(this, s[B](this[Q]));return this
		});qa(V, function() {
			oa(this, s[z](this[w]));Ua(this, s[z](this[Q]));return this
		});
		V.scale = function(a) {
			oa(this, this[w] * a);Ua(this, this[Q] * a);return this
		};
		function mq(a, b, c) {
		...
		var Zq,
			$q = !Hq || Yq(9);
		!Iq && !Hq || Hq && Yq(9) || Iq && Wq("1.9.1");Hq && Wq(Ve);
		function ar(a, b) {
			var c;
			c = (c = a.className) && typeof c[qc] == T ? c[qc](/\s+/) : [];var d = $p(arguments, 1),
				e;
			e = c;
			for (var f = 0, g = 0; g < d[I]; g++) 0 <= Lp(e, d[g]) || (e[v](d[g]), f++);
			e = f == d[I];Ka(a, c[cd](id));return e
		}
		;
		function br(a) {
		...
		function hr(a, b) {
			...
			c = a[Bb](c);d && (np(d) ? Ka(c, d) : jp(d) ? ar[Uc](l, [ c ][hb](d)) : er(c, d));2 < b[I] && ir(a, c, b, 2);return c
		}
		function ir(a, b, c, d) {
			function e(c) {
				c && b[t](np(c) ? a[lb](c) : c)
		...
		var Dr = !Hq || Yq(9),
			Er = !Hq || Yq(9),
			Fr = Hq && !Wq(Ue);
		!Jq || Wq("528");Iq && Wq("1.9b") || Hq && Wq(Ue) || Gq && Wq("9.5") || Jq && Wq("528");!Iq || Wq(Ue);
		function Gr(a, b) {
			Aa(this, a);Pa(this, b);wa(this, this[Ec])
		}
		xp(Gr, zr);
		V = Gr[K];
		V.lb = function() {
		...
		V.oc = function(a, b) {
			var c = Aa(this, a[F]);
			Gr[N](this, c);Pa(this, a[Ec] || a.srcElement);wa(this, b);
			var d = a[$a];
			if (d) {
				if (Iq) {
					var e;
		...
		function Qr(a, b, c, d, e) {
			if (b) {
				...
				f = Rr();
				f.src = a;
				g = new Kr;g.oc(c, f, a, b, d, e);
				c = g.key;
				f.key = c;j[v](g);
				Mr[c] = g;Or[i] || (Or[i] = []);Or[i][v](g);
				a.addEventListener ? (a == dp || !a.np) && a.addEventListener(b, f, d) : a.attachEvent(b in Pr ?
					Pr[b] : Pr[b] = kl + b, f);return c
			}
		...
		$r[K].removeAll = function() {
			Mp(this.wa, Vr);Ga(this.wa, 0)
		};
		$r[K].lb = function() {
			$r.Pb.lb[N](this);this[Ic]()
		};
		...
		function bs(a) {
			...
			if (/^\s*$/[Za](a) ? 0 : /^[\],:{}\s\u2028\u2029]*$/[Za](a[bb](/\\["\\\/bfnrtu]/g, nf)[bb](/"[^"\\\n\r\u2028\u2029\x00-\x08\x10-\x1f\x80-\x9f]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g, hg)[bb](/(?:^|:|,)(?:[\s\u2028\u2029]*\[)+/g, S))) try {
					return eval(de + a + fe)
				} catch (b) {} h(r("Invalid JSON string: " + a))
		}
		function cs(a) {
			this.Xi = a
		}
		...
		cs[K].gq = function(a, b) {
			b[v](td, a[bb](es, function(a) {
				...
				var b = a.charCodeAt(0),
					e = gg;
				16 > b ? e += Fe : 256 > b ? e += Ee : 4096 > b && (e += Ae);return ds[a] = e + b[ac](16)
			}), td)
		};
		...
		;
		function hs(a, b, c, d) {
			this.top = a;Va(this, b);Ra(this, c);xa(this, d)
		}
		Oa(hs[K], function() {
		...
		hs[K].Gn = function(a) {
			...
			this.top = s.min(this.top, a.top);Va(this, s.max(this[R], a[R]));Ra(this, s.max(this[P], a[P]))
		};
		function is(a, b) {
		...
		function js(a, b, c, d) {
			xa(this, a);
			this.top = b;oa(this, c);Ua(this, d)
		}
		Oa(js[K], function() {
		...
		function os(a) {
			a = a ? 9 == a[cb] ? a : dr(a) : ja;return Hq && !Yq(9) && !br(a).Kl() ? a[Bc] : a[Yb]
		}
		function ps(a) {
			var b = a[Ya]();
		...
		function rs(a) {
			for (var b = new hs(0, p, p, 0), c = br(a), d = c.nb[Bc], e = c.nb[Yb], f = c.ww(); a = qs(a);)
				if ((!Hq || 0 != a[kc]) && (!Jq || 0 != a[Mc] || a != d) && a != d && a != e && ns(a, sl) != Po) {
					...
					g.x += i.x;
					g.y += i.y;
					b.top = s.max(b.top, g.y);Va(b, s.min(b[R], g.x + a[kc]));Ra(b, s.min(b[P], g.y + a[Mc]));xa(b, s.max(b[C], g.x))
			}
			d = f[Nc];
			f = f[$b];xa(b, s.max(b[C], d));
			b.top = s.max(b.top, f);
			c = c.xw();
		...
		function ss(a) {
			...
			else if (c[Ab] && !e) b = c[Ab](a), a = c[Ab](g), f.x = b[xb] - a[xb], f.y = b[yb] - a[yb];else {
				b = a;
				do {
					f.x += b.offsetLeft;
					f.y += b.offsetTop;b != a && (f.x += b[Hb] || 0, f.y += b[Kb] || 0);
					if (Jq && ns(b, Pl) == Vi) {
						f.x += c[Bc][Nc];
						f.y += c[Bc][$b];break
					}
		...
		function us(a, b) {
			typeof a == gl && (a = (b ? s[z](a) : a) + Ul);return a
		}
		function vs(a) {
			...
			var b = a[zc],
				...
				d = b.visibility,
				e = b[fc];
			Fa(b, Dj);Ia(b, lg);Ta(b, Tj);
			a = ws(a);Ta(b, c);Ia(b, e);Fa(b, d);return a
		}
		function ws(a) {
			var b = a.offsetWidth,
				c = a.offsetHeight,
		...
		function Cs(a, b, c, d, e, f, g, i) {
			...
			m = ss(a);
			o = vs(a);
			m = new js(m.x, m.y, o[w], o[Q]);(o = rs(a)) && m.Jp(new js(o[C], o.top, o[R] - o[C], o[P] - o.top));var o = br(a),
				q = br(c);
			if (o.nb != q.nb) {
				var u = o.nb[Bc],
					q = q.Ip(),
				...
				do {
					...
					if (D == q)
						...
						L = new $;
						if (1 == X[cb])
							if (X[Ya]) X = ps(X), L.x = X[C], L.y = X.top;else {
								var G = br(X).Oi(),
									X = ss(X);
								L.x = X.x - G.x;
								L.y = X.y - G.y
				...
				u = jq(y, ss(u));Hq && !o.Kl() && (u = jq(u, o.Oi()));xa(m, m[C] + u.x);
				m.top += u.y
			}
			a = (b & 4 && ts(a) ? b ^ 2 : b) & -5;
			b = new $(a & 2 ? m[C] + m[w] : m[C], a & 1 ? m.top + m[Q] : m.top);j && (b = jq(b, j));e && (b.x += (a & 2 ? -1 : 1) * e.x, b.y += (a & 1 ? -1 : 1) * e.y);var na;
		...
		function Ds(a, b, c, d, e, f, g) {
			...
			f = a;
			e = Iq && (Bq || Mq) && Wq(Je);
			f instanceof $ ? (a = f.x, f = f.y) : (a = f, f = ba);xa(b[zc], us(a, e));
			b[zc].top = us(f, e);
		...
		Ba(V, function() {
			this.Oa = {};Ga(this.wa, 0);
			this.eh = this.Ua = 0
		});
		V.remove = function(a) {
			return Ns(this.Oa, a) ? (
				delete this.Oa[a]
				, this.Ua--, this.eh++, this.wa[I] > 2 * this.Ua && this.bh(), k) : n
		};
		V.bh = function() {
			if (this.Ua != this.wa[I]) {
				for (var a = 0, b = 0; a < this.wa[I];) {
					var c = this.wa[a];
					Ns(this.Oa, c) && (this.wa[b++] = c);a++
				}
				Ga(this.wa, b)
			}
			if (this.Ua != this.wa[I]) {
		...
		V.Tl = function(a) {
			...
			Ma(g, function() {
				for (;;) {
					e != f.eh && h(r("The map has changed since the iterator was created"));b >= c[I] && h(Hs);var g = c[b++];
					return a ? g : d[g]
				}
			});return g
		};
		...
		V.Xw = function(a) {
			...
			!(a instanceof Ps) && 5 < b && (a = new Ps(a));return Ls(this, function(b) {
		...
		V.dispatchEvent = function(a) {
			...
			if (b in c) {
				if (np(a))
					a = new Gr(a, this);
				else if (a instanceof Gr) Pa(a, a[Ec] || this);else {
					var d = a,
						a = new Gr(b, this);
					vq(a, d)
				}
		...
		V.lb = function() {
			Ss.Pb.lb[N](this);this.stop();
			delete this.ih
		};
		function Us(a, b, c) {
			pp(a) ? c && (a = Z(a, c)) : a && typeof a[Lb] == T ? a = Z(a[Lb], a) : h(r(Ff));return 2147483647 < b ? -1 : Ts[mc](a, b || 0)
		}
		;
		function Vs(a) {
			return a
		...
		;
		function Ws(a, b) {
			this.Dc = new $r(this);this.wl(a || l);b && this.Hw(b)
		}
		xp(Ws, Rs);
		V = Ws[K];
		V.Ga = l;
		...
		V.Df = function(a) {
			this.Tg && this.Tg.stop();this.$g && this.$g.stop();
			a ? this.zw() : this.Pi()
		};
		V.Oc = fp;
		V.zw = function() {
			if (!this.Jf && this.bl()) {
				this.Ga || h(r("Caller must call setElement before trying to show the popup"));this.Oc();
				var a = dr(this.Ga);
				...
				if (this.yu)
					if (this.Dc.If(a, Uk, this.ap, k), Hq) {
						...
						this.Dc.If(a, Uk, this.ap, k);this.Dc.If(a, xi, this.$o)
		...
		V.Pi = function(a) {
			...
			this.Dc && this.Dc[Ic]();
			this.$g ? (Tr(this.$g, Ni, vp(this.Xp, a), n, this), this.$g.play()) : this.Xp(a);return k
		};
		V.Xp = function(a) {
		...
		V.Bu = function() {
			Fa(this.Ga[zc], Po);xs(this.Ga, k)
		};
		V.Zp = function() {
			Fa(this.Ga[zc], Dj);xs(this.Ga, n)
		};
		V.jw = function() {
			xa(this.Ga[zc], le);
			this.Ga[zc].top = le
		...
		V.ap = function(a) {
			a = a[Ec];!nr(this.Ga, a) && (!this.Up || nr(this.Up, a)) && !this.Sp() && this.Pi(a)
		};
		V.Au = function(a) {
		...
		V.lb = function() {
			Ws.Pb.lb[N](this);this.Dc.cc();Br(this.Tg);Br(this.$g);
			delete this.Ga;
			delete this.Dc
		};
		function Xs(a, b) {
			this.Qt = 4;
			this.m = b || ba;Ws[N](this, a)
		}
		xp(Xs, Ws);
		Xs[K].re = function() {
			return this.m || l
		...
		Xs[K].Qw = function(a) {
			this.m = a || ba;this.B() && this.Oc()
		};
		Xs[K].Oc = function() {
			if (this.m) {
				var a = !this.B() && this.Cf != $k,
					b = this.q();
				a && (Fa(b[zc], Dj), xs(b, k));this.m.Oc(b, this.Qt, this.Cx);a && xs(b, n)
			}
		};
		function Ys(a, b, c) {
			this.Ai = c || (a ? br(np(a) ? ja[gb](a) : a) : br());Xs[N](this, this.Ai.ep(Di, {
				style : Rl
			}));
			this.Ll = new $(1, 1);
			this.Ce = new Ps;a && this.lw(a);b != l && this.rw(b)
		}
		xp(Ys, Xs);
		var Zs = [];
		V = Ys[K];
		V.Rb = l;Ka(V, "goog-tooltip");
		V.mq = 500;
		V.nq = 0;
		V.lw = function(a) {
			a = np(a) ? ja[gb](a) : a;this.Ce.add(a);Qr(a, Xk, this.cq, n, this);Qr(a, Wk, this.Vi, n, this);Qr(a, Vk, this.bq, n, this);Qr(a, Xi, this.aq, n, this);Qr(a, Wg, this.Vi, n, this)
		};
		V.detach = function(a) {
		...
		V.jq = function(a) {
			Ur(a, Xk, this.cq, n, this);Ur(a, Wk, this.Vi, n, this);Ur(a, Vk, this.bq, n, this);Ur(a, Xi, this.aq, n, this);Ur(a, Wg, this.Vi, n, this)
		};
		V.Fv = function(a) {
			this.mq = a
		};
		...
		V.wl = function(a) {
			var b = this.q();
			b && mr(b);Ys.Pb.wl[N](this, a);a && (b = this.Ai.nb[Bc], b.insertBefore(a, b.lastChild))
		};
		V.getState = function() {
		...
		V.bl = function() {
			...
			a = this.q();Ka(a, this.className);this.Fi();Qr(a, Xk, this.dp, n, this);Qr(a, Wk, this.cp, n, this);this.$k();return k
		};
		V.vl = function() {
			Wp(Zs, this);
			for (var a = this.q(), b, c = 0; b = Zs[c]; c++) b[Hc] && nr(a, b[Hc]) && b.Df(n);
			this.jp && this.jp.jl();Ur(a, Xk, this.dp, n, this);Ur(a, Wk, this.cp, n, this);Qa(this, ba);
			if (0 == this.getState())
				this.yi = n;
			Ws[K].vl[N](this)
		};
		...
		V.cv = function(a, b) {
			Qa(this, a);this.Qw(b || this.Gp(0));this.Df(k)
		};
		V.Sw = function(a) {
			this.Wg = ba;a == this[Hc] && (this.Rb == l || this.Rb != this.q() && !this.Ce[Tc](this.Rb)) && !this.Lu() && this.Df(n)
		};
		V.Lu = function() {
		...
		V.cq = function(a) {
			var b = this.Ei(a[Ec]);
			this.Rb = b;this.Fi();b != this[Hc] && (Qa(this, b), this.Kp(b), this.Hp(), this.Pp(a))
		};
		V.Ei = function(a) {
			try {
		...
		V.lb = function() {
			this.Df(n);this.$k();this.detach();this.q() && mr(this.q());
			this.Rb = l;
			delete this.Ai;
			Ys.Pb.lb[N](this)
		};
		...
		$s[K].Oc = function(a, b, c) {
			b = os(a);
			b = rs(b);
			c = c ? new hs(c.top + 10, c[R], c[P], c[C] + 10) : new hs(10, 0, 0, 10);Ds(this.u, a, 4, c, b, 9) & 496 && Ds(this.u, a, 4, c, b, 5)
		};
		function at(a) {
			Fs[N](this, a, 3)
		}
		...
		var ht = /#(.)(.)(.)/;
		function et(a) {
			dt[Za](a) || h(r("'" + a + "' is not a valid hex color"));4 == a[I] && (a = a[bb](ht, vd));return a[fd]()
		}
		function it(a) {
			a = et(a);return [ ga(a[Zb](1, 2), 16), ga(a[Zb](3, 2), 16), ga(a[Zb](5, 2), 16) ]
		}
		function jt(a, b, c) {
			a = ea(a);
			b = ea(b);
			c = ea(c);(ka(a) || 0 > a || 255 < a || ka(b) || 0 > b || 255 < b || ka(c) || 0 > c || 255 < c) && h(r('"(' + a + ge + b + ge + c + '") is not a valid RGB color'));
			a = kt(a[ac](16));
			b = kt(b[ac](16));
			c = kt(c[ac](16));return ud + a + b + c
		}
		function gt(a) {
		...
		function lt(a, b, c) {
			c = pr(c, 0, 1);return [ s[z](c * a[0] + (1 - c) * b[0]), s[z](c * a[1] + (1 - c) * b[1]), s[z](c * a[2] + (1 - c) * b[2]) ]
		}
		;
		function mt(a) {
		...
		function nt(a) {
			if (a == U) return U;
			a = it(a);
			a = s[z]((a[0] + a[1] + a[2]) / 3);return jt(a, a, a)
		}
		function ot(a, b) {
			a = sq(a);
			if (!W(a[bc]))
		...
		;
		function rt(a, b, c) {
			c = W(c) ? c : 1.0E-5;return a == b || s.abs(a - b) <= c
		}
		function st(a, b, c) {
		...
		function wt(a) {
			W(a) || (a = {});
			this.O = U;W(a.fill) && this.Fk(a.fill);
			this.$b = 1;W(a.rb) && this.dk(a.rb);
			this.Jb = U;W(a.stroke) && this.gc(a.stroke);
			this.H = 1;W(a.Qa) && this.ee(a.Qa);
			this.nc = 1;W(a.vd) && this.bg(a.vd);
			this.jd = $m;W(a.io) && this.co(a.io);
			this.F = l;
			if (a.F) this.F = sq(a.F), this.F.Kd = mt(this.F.Kd), this.F.Ld = mt(this.F.Ld);
			this.Ea = l;a.pattern && this.Kk(a.pattern)
		}
		V = wt[K];
		Oa(V, function() {
			var a = new wt;
			...
			a.Ea = this.Ea ? this.Ea[Dc]() : l;return a
		});
		V.$h = function() {
			var a = this[Dc]();
			a.Fk(nt(this.O));a.gc(nt(this.Jb));
			if (this.F) {
				var b = sq(this.F);
				b.Kd = nt(this.F.Kd);
				b.Ld = nt(this.F.Ld);
			...
			this.Ea && a.Kk(this.Ea.$h());return a
		};
		V.Fk = function(a) {
			this.O = mt(a)
		};
		...
		Dt[K].ib = function(a) {
			this.Ui = a;this.Mg() && Bt(this.Ga, a)
		};
		Dt[K].Nn = function() {
		...
		V = It[K];oa(V, 0);Ua(V, 0);
		V.qs = function(a, b) {
			var c = this.hq(a, b);
			c.ib(kg);return c
		};Ba(V, function() {
			this.Pd.cc();
			this.Pd = new $r;Mp(this.ll, function(a) {
				a.lb()
			});Vp(this.ll);this.Qo(this.Nc[gb](Gh))
		});
		V.ib = function(a, b) {
		...
		V.qf = function(a, b, c) {
			a[sc] == Dt && (a = a.q());this.Pd.If(a, b, c)
		};
		V.is = function(a, b, c) {
			a = new Ys(a);
			b = this.Wd.ep(Di, S, b);ks(b, c);a.q()[t](b);a.Fv(100);a.Ev(100);this.ll[v](a);return a
		};
		V.appendChild = function(a, b) {
			if (b) {
				var c;
		...
		V.replaceChild = function(a, b, c) {
			this.Dp(a).replaceChild(b, c);Xr(c)
		};
		V.Ng = function(a) {
			a.Mg() && this.Qo(a.q())
		};
		...
		V.Zj = function(a, b, c, d, e) {
			a = this.Uh(a, b, c, d);this[t](e, a);return a
		};
		V.um = function(a, b, c, d, e, f) {
			a = this.wq(a, b, c, d, e);this[t](f, a);return a
		};
		V.Wa = function(a, b, c, d, e, f) {
			a = this.ne(a, b, c, d, e);this[t](f, a);return a
		};
		V.xa = function(a, b, c) {
			a = this.oe(a, b);this[t](c, a);return a
		};
		V.rh = function(a, b, c, d, e, f, g, i) {
			a = this.xq(a, b, c, d, e, f, g);this[t](i, a);return a
		};
		V.ct = function(a, b, c, d, e, f, g, i, j) {
			a = this.Yi(a, b, c, d, e, f, g, i);this[t](j, a);return a
		};
		V.js = function(a, b, c, d, e, f, g, i, j) {
			a = this.Zi(a, b, c, d, e, f, g, i);this[t](j, a);return a
		};
		V.Ju = function(a, b) {
		...
		V.yw = function(a, b) {
			...
			case Zk:
				...
				this.Yo(a, c.x, c.y);
				break;case Ak:
				c = b[A];this.Xo(a, c.x, c.y);
				break;case ji:
				c = b[A];this.Wo(a, c.Cb, c.Db, c.gd, c.hd, c.x, c.y);
				break;case Bg:
				c = b[A];this.Uo(a, c.ml, c.nl, c.ol, c.pl, c.Ho, c.ql, c.Io);
				break;case Vh:
				this.Vo(a)
			}
		};
		...
		V.hq = function(a, b) {
			oa(this, a);Ua(this, b);
			var c = this.fb(wn);
			c[E](Mj, Fh);c[E](To, a);c[E](Bj, b);this.Nc[gb](Gh)[t](c);
			this.Ff = this.fb(zi);this.Ff[E](Mj, zi);
			this.Ji = {};c[t](this.Ff);return new Dt(c)
		};
		V.Qp = function() {
		...
		V.Uh = function(a, b, c, d) {
			var e = this.fb(Ph);
			e[E](li, a);e[E](mi, b);e[E](Vl, c);this.Ec(e, d);return e
		};
		V.wq = function(a, b, c, d, e) {
			var f = this.fb(Ki);
			f[E](li, a);f[E](mi, b);f[E](om, c);f[E](pm, d);this.Ec(f, e);return f
		};
		V.ne = function(a, b, c, d, e) {
			var f = this.fb(Zl);
			f[E](Vo, a);f[E](Yo, b);f[E](To, c);f[E](Bj, d);this.Ec(f, e);return f
		};
		V.tq = function(a, b) {
			var c = this.fb(xl);
			c[E](ni, a[cd](S));this.Ec(c, b);return c
		};
		...
		V.Zi = function(a, b, c, d, e, f, g, i) {
			...
			if (i[tb] && i[tb] != U && i.$a && i.$a != U) {
				var m = new wt({
					...
					o = this.ja();
				this.Yg(a, b, c, d, e, f, g, i, m, o);this.Yg(a, b, c, d, e, f, g, i, j, o);return o.q()
			}
		...
		V.Xg = function(a, b, c, d, e, f, g, i, j) {
			...
			g = Ht(g[O], g.end, Ni);
			g -= 0.15 * i[M];
			g = new wr(0, g);g[xc](sr(e));
			c = new wr(b, c);c.add(g);
			b = c.x;
			c = c.y;d[t](this.Nc[lb](a));switch (f) {
			case fn:
				d[E](Bn, fn);
				break;case Eh:
				d[E](Bn, Ok);
			...
			d[E](Vo, b);d[E](Yo, c);d[E](Zi, i.zb);d[E]($i, i[M] || 0);i[bc] && d[E](bj, Xg);i.zf && d[E](aj, bk);i.$n && d[E](Cn, ro);0 != e && d[E](ko, km + e + id + b + id + c + fe);this.Ec(d, j);return d
		};
		V.Yg = function(a, b, c, d, e, f, g, i, j, m) {
			a = this.Xg(a, b, c, d, e, f, g, i, j);this[t](m, a);return a
		};
		V.Lp = function() {
			return this.fb(nj)
		};
		V.en = function(a, b) {
			var c = Kt(),
				d = this.fb(Th),
				e = this.fb(Zl);
			e[E](Vo, b[C]);e[E](Yo, b.top);e[E](To, b[w]);e[E](Bj, b[Q]);d[t](e);d[E](Mj, c);this.Ff[t](d);
			d = a.q();d[E](Sh, so + c + fe);return d
		};
		V.Yo = function(a, b, c) {
			a[v](If + b + ge + c)
		};
		...
		V.Uo = function(a, b, c, d, e, f, g, i) {
			var f = rr(f),
				...
				m = e * s.sin(sr(g - 90)),
				f = i ? g - f : f - g;
			0 > f && (f += 360);a[v](of + d + ge + e + je + (180 < f ? 1 : 0) + ge + (i ? 1 : 0) + ge + (b + j) + ge + (c + m))
		};
		V.Kg = function(a, b, c) {
			a[E](ko, lo + b + ie + c + fe)
		};
		...
		V.Rp = function(a, b) {
			...
			if (!c) {
				var d = this.Nc,
					...
					e = c[zc];
				Ta(e, U);Ia(e, lg);
				e.top = this[Q] + 10 + Ul;xa(e, this[w] + 10 + Ul);
				e.whiteSpace = el;c[t](d[lb](id));d[Bc][t](c);
				this.dh = c
			}
			c[Gb].data = a;
			e = c[zc];ra(e, b.zb);Na(e, b[M] + Ul);
			e.fontWeight = b[bc] ? Xg : S;
			e.fontStyle = b.zf ? bk : S;Ta(e, Vg);
			d = c[kc];
			c = c[Mc];Ta(e, U);return new lq(d, c)
		};
		V.fb = function(a) {
		...
		V.Ec = function(a, b) {
			...
			else if (W(b.Ea)) c = this.it(b.Ea), a[E](Ri, so + c + fe);else a[E](Ri, b.O)
		};
		V.ht = function(a) {
			var b = Kt(),
				c = this.fb(Ek),
				...
				f = a.Db,
				g = a.hd;
			typeof d == pn && d[ib](d[I] - 1) == Yd && (d = s[z](ga(d, 10) * this[w] / 100));typeof e == pn && e[ib](e[I] - 1) == Yd && (e = s[z](ga(e, 10) * this[w] / 100));typeof f == pn && f[ib](f[I] - 1) == Yd && (f = s[z](ga(f, 10) * this[Q] / 100));typeof g == pn && g[ib](g[I] - 1) == Yd && (g = s[z](ga(g, 10) * this[Q] / 100));c[E](Mj, b);c[E](Wo, d);c[E](Zo, f);c[E](Xo, e);c[E]($o, g);c[E](tj, to);
			d = this.fb(ln);d[E](jl, De);d[E](vn, mn + a.Kd);c[t](d);
			d = this.fb(ln);d[E](jl, Ke);d[E](vn, mn + a.Ld);c[t](d);this.Ff[t](c);
			return b
		};
		V.it = function(a) {
		...
		V.Zv = function(a) {
			var b = this.fb(zl);
			b[E](Al, to);b[E](Vo, Ae);b[E](Yo, Ae);b[E](To, Oe);b[E](Bj, Oe);b[E](Lo, Ce);
			var c = this.fb(Zl);
			c[E](Vo, Ae);c[E](Yo, Ae);c[E](To, Oe);c[E](Bj, Oe);c[E](Ri, a.xe);b[t](c);
			c = this.fb(nj);c[E](qn, a.ye);c[E](sn, dn);
			a = this.fb(Ak);a[E](Wo, Ne);a[E](Zo, Ae);a[E](Xo, Oe);a[E]($o, Ne);a[E](un, Ne);c[t](a);
			a = this.fb(Ak);a[E](Wo, Ae);a[E](Zo, Ne);a[E](Xo, Ne);a[E]($o, Oe);a[E](un, Ne);c[t](a);b[t](c);return b
		};
		function Mt(a, b) {
			switch (a) {
			case $m:
				return Ae;case oi:
				return S + 4 * b + ge + (S + b);default:
				return Mt($m, b)
			}
		}
		;
		...
		function Ot(a, b, c) {
			a = ep(b, a);return W(a) && pp(c) ? c(a) : a
		}
		V = Nt[K];
		V.R = function(a, b, c) {
		...
		function Pt(a) {
			...
			a = S + a;return a == Ge || a[fd]() == oo ? k : a == Ae || a[fd]() == Qi ? n : l
		}
		V.za = function(a, b) {
			var c = this.Go(a);
			if (W(c)) return c;
		...
		V.zh = function(a, b) {
			var c = this.fi(a, b, function(a) {
				...
				c = new wt(c);
			c.Qg() || (c.Fk(xt.O), c.dk(xt.$b));c.pd() || (c.gc(xt.Jb), c.bg(xt.nc));return c
		};
		V.vc = function(a, b) {
		...
		function Wt(a, b, c) {
			b || h(r("viscommon: container cannot be null"));var d = !!c,
				e = gr(Di, {
					style : Ql
				}),
				c = ns(b, Pl);
			(c == S || c == gn) && ks(b, Pl, am);return {
				addError : function(c) {
		...
		V.hq = function(a, b) {
			oa(this, a);Ua(this, b);
			var c = this.xb(Di);
			this.Td(c, -5E4, -5E4, this[w] + 1E5, this[Q] + 1E5);this.Nc[gb](Gh)[t](c);
			var d = this.ja(),
				e = d.q();
			e.id = Fh;
			e.coordorigin = Be;
			e.coordsize = a + id + b;
			e[zc].top = 5E4;xa(e[zc], 5E4);c[t](e);return d
		};qa(V, function(a) {
			return s[z](a)
		});
		V.Uh = function(a, b, c, d) {
			var e = this.xb(yo),
				f = 2 * c;
			this.Td(e, a - c, b - c, f, f);this.Ec(e, d, n);return e
		};
		V.wq = function(a, b, c, d, e) {
			var f = this.xb(yo);
			this.Td(f, a - c, b - d, 2 * c, 2 * d);this.Ec(f, e, n);return f
		};
		V.ne = function(a, b, c, d, e) {
			var f = this.xb(Ao),
			...
			this.Td(f, a, b, c, d);return f
		};
		V.tq = function(a, b) {
			for (var c = this.xb(Bo), d = this.xb(zo); 0 < a[I] && 0 == Jp(a)[Jc](If, 0);) a = $p(a, 0, a[I] - 1);
			d[E](uo, a[cd](S));this.Td(c, 0, 0, this[w], this[Q]);c[t](d);this.Ec(c, b, n);return c
		};
		V.xq = function(a, b, c, d, e, f, g) {
			b = Gt(b, d, e);
			c = Gt(c, g[M], f);
			f = Eh;
			c = Ht(c[O], c.end, f);return this.Yi(a, b[O], c, b.end, c, e, f, g)
		};
		V.Yi = function(a, b, c, d, e, f, g, i) {
			var j = new wt({
				fill : i[tb]
		...
		V.Xg = function(a, b, c, d, e, f, g, i, j) {
			...
			d = s[z](d);
			e = s[z](e);
			g = this.xb(zo);g[E](uo, If + b + ge + c + Gf + d + ge + e + zf);g[E](In, oo);
			b = this.xb(Do);b[E](kl, oo);
			d = b[zc];Na(d, i[M]);ra(d, i.zb);switch (f) {
			case fn:
				d[E](vo, hk);
				break;case Eh:
				d[E](vo, Eh);
			...
			if (i.zf)
				d.fontStyle = bk;
			b[E](pn, a);m[t](g);m[t](b);this.Ec(m, j, n);return m
		};
		V.Yg = function(a, b, c, d, e, f, g, i, j, m) {
			a = this.Xg(a, b, c, d, e, f, g, i, j);this[t](m, a);return a
		};
		V.Lp = function() {
			var a = this.xb(xo);
			this.Td(a, 0, 0, this[w], this[Q]);return a
		};
		V.en = function(a, b) {
			var c = this.xb(Di),
				d = [ this.Gb(5E4 + b.top), this.Gb(5E4 + b[C] + b[w]), this.Gb(5E4 + b.top + b[Q]), this.Gb(5E4 + b[C]) ];
			c[zc].clip = $l + d[cd](ie) + fe;this.Td(c, 0, 0, this[w] + 1E5, this[Q] + 1E5);a.q();
			d = new Dt(c);this[t](d, a);this.Wa(1, 1, 1, 1, new wt({
				fill : So
			}), d);return c
		};
		V.Yo = function(a, b, c) {
		...
		V.Kg = function(a, b, c) {
			a[zc].top = this.Gb(c);xa(a[zc], this.Gb(b))
		};
		V.Qk = function(a, b) {
			oa(a[zc], this.Gb(b))
		};
		...
		V.Rp = function(a, b) {
			...
			if (c == l) {
				var c = this.xb(Di),
					d = c[zc];
				Ta(d, U);Ia(d, lg);
				d.top = this.Gb(this[Q] + 10);xa(d, this.Gb(this[w] + 10));
				d.whiteSpace = el;
				d = this.Nc;c[t](d[lb](id));d[Bc][t](c);
				this.dh = c
			}
			c[Gb].data = a;
			d = c[zc];ra(d, b.zb);Na(d, this.Gb(b[M] || 0));
			d.fontWeight = b[bc] ? Xg : S;
			d.fontStyle = b.zf ? bk : S;Ta(d, Vg);
			var e = c[kc],
				c = c[Mc];
			Ta(d, U);b[bc] && (e *= 1.1);b.zf && (e *= 0.9);return new lq(e, c)
		};
		V.Gb = function(a) {
			return s[z](a) + Ul
		};
		...
		V.Ec = function(a, b, c) {
			...
			if (b.pd()) {
				if (ua(a, k), a.strokeweight = b.H, a.strokecolor = b.Jb, c = !b.fo(), d = b.ho(), c || d) {
					...
					d && (e.dashstyle = $t(b.jd));a[t](e)
				}
			} else
				c && b.Af() ? (ua(a, k), a.strokeweight = 1, a.strokecolor = b.O) : ua(a, n);
			if (hp(a.filled))
				a.filled = k;
			c = b.F;
			if (W(b.F)) {
				b = this.xb(wo);b[E](Yh, c.Kd);b[E](Zh, c.Ld);
				var d = c.Cb,
					e = c.Db,
					f = c.gd,
					c = c.hd;
				typeof d == pn && (d = ga(d,
					10));typeof e == pn && (e = ga(e, 10));typeof f == pn && (f = ga(f, 10));typeof c == pn && (c = ga(c, 10));
				c = rr(180 * s[Db](c - e, f - d) / s.PI);
				c = qr(270 - c, 360);b[E](mg, c);b[E](po, sj);a[t](b)
			} else
				b.Ea ? (b = this.Xs(b.Ea), a[t](b)) : b.O == U ? a.filled = n : b.Af() ? a.fillcolor = b.O : (c = this.xb(wo), c.opacity = S + s[z](100 * b.$b) + Yd, va(c, b.O), a[t](c))
		};
		V.Xs = function(a) {
			var b = this.xb(wo);
			b[E](po, zl);b[E](Yh, a.ye);b[E](Zh, a.xe);
			var c = ep(qj);
			W(c) || (c = Jj);
			var d = ep(rj);
			W(d) || (d = He);b[E](en, c + ze + d + ye + a.ze + qe);return b
		};
		V.Td = function(a, b, c, d, e) {
			a = a[zc];Ia(a, lg);xa(a, this.Gb(b));
			a.top = this.Gb(c);oa(a, this.Gb(d));Ua(a, this.Gb(e))
		};
		function $t(a) {
			switch (a) {
			case $m:
		...
		function au(a, b) {
			...
			this.Wd = br(this.wb);
			this.Nb = l;
			c = !Hq ? n : W(ja[Pc]) ? 9 > ja[Pc] : !Wq(Ve);this.Qv(b, c);bu(Z(this.Sv, this), Z(this.Rv, this, c))
		}
		xp(au, zr);
		V = au[K];
		V.Rv = function(a) {
		...
		V.Qv = function(a, b) {
			var c = this.Wd[Bb](Nj);
			c.name = this.xl;
			c.id = this.xl;oa(c, a[w][ac]());Ua(c, a[Q][ac]());
			c.frameBorder = 0;
			c.scrolling = dl;
			c.marginHeight = 0;
			c.marginWidth = 0;
			c.allowTransparency = oo;b || Aa(c, Oj);
			this.wb.innerHTML = S;this.Wd[t](this.wb, c);
			c = c[Wc] || c[Ub][nc];c.open();
			var d = [];
			b ? (d[v](hf), d[v](gf), d[v](lf)) : (d[v](df), d[v](jf), d[v](rd), d[v](sd), d[v](gf));d[v](kf);d[v](Jo);d[v](mj);d[v](nd);d[v](cp);d[v](cf);d[v](af);d[v](ef);d[v](pd);d[v](mf);d[v](ff);d[v]($e);d[v](bf);c.write(d[cd](gd));c[Ac]()
		};
		function bu(a, b, c) {
			hp(c) || (c = 50);
		...
		function iu(a) {
			...
			case Ak:
			case ji:
				return a = a[A], new $(a.x, a.y);case Bg:
				var a = a[A],
					b = rr(a.ql);
		...
		V.jt = function() {
			for (var a = [], b = l, c = 0; c < this.eb[I]; c++) {
				...
				if (e[F] == Zk)
					...
					d = g}iq(d.ob, b) || d.eb[rb](b.x, b.y);d.eb.ac(e);
					b = d.ob = iu(e)
				}
			}
			return a
		...
		function ku(a, b, c) {
			var d = b.ja(),
				...
				i = e.Eb;
			f[rb](g[C] + 1, g[P]);f.jb(g[C] + 1, g[P] - 1, 1, 1, 180, 270, k);f.G(g[C], g.top + 1);f.jb(g[C] + 1, g.top + 1, 1, 1, 270, 0, k);
			if (W(i) && i[0].y == e.p.top)
				for (var j = 0; 3 > j; ++j) f.G(i[j].x + 0.5, i[j].y + 0.5);
			f.G(g[R] - 1, g.top);f.jb(g[R] - 1, g.top + 1, 1, 1, 0, 90, k);f.G(g[R], g[P] - 1);f.jb(g[R] - 1, g[P] - 1, 1, 1, 90, 180, k);
			if (W(i) && i[0].y == e.p[P])
		...
		function Ou(a, b, c) {
			...
			b = (a.y / a.x + b.y / b.x) / 2;return 0 < a.x ? {
				x : c,
				y : c * b
			} : {
				x : -c,
		...
		function Pu(a, b, c) {
			...
			d = s[Ib](d / e);return xr(a[Dc]()[Rc](1 / d), b[Dc]()[Rc](d))[Rc](c / 6)
		}
		...
		V.drawChart = function(a, b) {
			...
			var d = this.Ia = d[ad](),
				e = c.qs(d[w], d[Q]);
			c.ib(e, Fh);c.qf(e, ii, Hr);c.qf(e, Rh, Z(function(a) {
				return this[ub](Lh, {
					ds : c.Nn(a[Ec])
				}, a)
			}, this));
			var f = d.cj;
			f && !f.xg() && c.Wa(0, 0, d[w], d[Q], f, e);d.Pe == ol && this.g.ib(this.yd(d[J], e), Nn);
			this.Kc = c.ja(k);this.Kc.ib(ik);this.ln(d.f);d.f[fc] != Pj && c[t](e, this.Kc);this.Mn(d, e) || this.rs(d, e);
		...
		V.hs = function(a, b, c, d) {
			var e = this.g,
				f = e.ja();
			e.Wa(a, b, 12, 12, c, f);e[t](d, f);
			c = new Et;c[rb](a + 2, b + 2);c.G(a + 12 - 2, b + 12 - 2);c[rb](a + 12 - 2, b + 2);c.G(a + 2, b + 12 - 2);
			a = new wt;a.gc(Ud);a.ee(2);e.xa(c, a, f);return f.q()
		};
		V.dt = function(a, b, c) {
			var d = b[M],
				a = this.g.Ju(a, b);
			a > c && (d = s.max(1, s[B](b[M] * c / a)));return d
		};
		V.Mk = function(a, b) {
			var c = hp(b) ? b : l,
		...
		V.Pm = function(a, b) {
			...
			this.Cc[Hu([ Ij, b ])] = c.q();this.Ia.z && this.zc(c.q(), {
				click : $n,
				mouseover : bo,
				mouseout : co
			}, l)
		...
		V.yd = function(a, b, c) {
			(a = this.Sn(a, c)) && this.g[t](b, a);return a
		};
		V.Sn = function(a, b) {
			var c = a.d;
			if (!c || 0 == c[I]) return l;
		...
		function vv(a, b) {
			...
			!d & a.wr && (d = b ? g : a.c[I] - 1, f = b ? f : 0, W(d) && W(f) && a.c[d] && a.c[f] && (o = a.c[f].Eg || a.Ha, a.ek ? c.pi(o, a.c[d].md.x, a.c[d].md.y, a.c[f].ld.x, a.c[f].ld.y, a.c[f].i.x, a.c[f].i.y) : c[Ac](o)));return c
		}
		function wv(a) {
		...
		V.Mn = function(a, b) {
			this.Jr(a);
			var c = this.g.ja(n);
			c.ib(Oh);this.g[t](b, c);mq(this.la, function(a, b) {
				if (!a.ma) a.ma = this.g.ja(!hp(a.Mm) || a.Mm), a.ma.ib(b)
			}, this);this.g.Wa(a.a[C], a.a.top, a.a[w], a.a[Q], a.bj, c);Mp(a.ta, function(b) {
				this.Hr(a, b)
			}, this);Mp(a.Ka, function(b) {
				this.Ir(a, b)
			}, this);Mp(a.ta, function(b) {
				this.gn(a, b)
			}, this);Mp(a.Ka, function(b) {
				this.gn(a, b)
			}, this);a.Pe == Pj && this.yd(a[J], this.la[J].ma);a.cg && this.yd(a.cg, this.la.axistitle.ma);Mp(a.v, function(a, b) {
			...
			var d = new js(a.a[C], a.a.top, a.a[w], a.a[Q]),
				g = this.g.ja(n),
				d = this.g.en(g, d);
			this.g[t](c, d);Mp(this.Gr, function(a) {
				var d = this.la[a].ma;
				if (d) {
					var e;
					switch (this.la[a][fc]) {
			...
			this.g.qf(c,
				Rh, Z(function(a) {
					...
					W(b) && this[ub](si, b, a)
				}, this));this.g.qf(c, Vk, Z(function(a) {
				var b = this.fn(new $(a[Wb], a[Xb]));
				W(b) ? this[ub](ti, b, a) : this[ub](ui, l, a)
			}, this));this.g.qf(c, Wk, Z(function(a) {
				this[ub](ui, l, a)
			}, this));return k
		};
		V.Jr = function(a) {
		...
		V.$p = function(a, b) {
			...
			for (d in a) {
				var e = a[d];
				if (e[vc][Tc](b) && (!c || e.$ > c.$ || e.$ == c.$ && e.Sa > c.Sa))
					c = {
						$ : e.$,
						Sa : e.Sa
				}
		...
		V.Xj = function(a, b) {
			a[F] == sh ? this.$u(a, b) : a[F] == Pg ? this.pp(a, b) : a[F] == hn ? this.pp(a, b) : a[F] == wh ? this.av(a, b) : a[F] == Cg ? this.Zu(a, b, this.Ia.Vc) : this.Sm(a, b, this.Ia.Qe);a.hc && a.hc.fk && this.bv(a, b)
		};
		V.bv = function(a, b) {
			for (var c = a.hc.fk, d = 0, e; e = c[d]; ++d)
				if (0 != e.tb[I]) {
					var f = new Et;
					f.Dk(e.tb, e.mm);e[P] && f.Dk(e[P], e.Qr);
					var g = this.g.ja();
					this.g.xa(f, e.b, g);
					e = g.q();this.yc(this.la.pathinterval.ma, Hu([ yl, b, d ]), e)
			}
		};
		...
		V.Lo = function(a, b, c, d) {
			if (c && c.i) {
				...
				e = j ? j.q() : e;this.yc(this.la[f].ma, g, e);c.K && this.wh(c.K, b, d);c.i.Wc && this.Lm(a, b, d, c.i.Wc);this.Ia.z && a.z && (b = {
					rect : new js(i[C],
						i.top, i[w], i[Q]),
					$ : b,
					Sa : d
		...
		V.Zu = function(a, b, c) {
			if (0 != a.c[I]) {
				...
				for (var g = 0; g < a.c[I]; g++) {
					var i = a.c[g].i;
					f.G(i.Jh, i.Kh);(i.Hh != i.Jh || i.Ih != i.Kh) && f.G(i.Hh, i.Ih);W(i.x) && W(i.y) && (d = n, e = g)
				}
				if (!d) {
					if (c)
					...
					g = Hu([ Cg, b ]);
					f = this.g.oe(f, a.Jq);this.yc(this.la.area.ma, g, f);
					if (c) {
						g = wv(a);
						c = Hu([ Ak, b ]);
						if (f = g.oe(this.g)) {
							...
							if (e || i)
								d = this.g.ja();
							if (e)
								for (g = 0; g < e.Ca[I]; g++) this.g.xa(e.Ca[g][Mb], e.Ca[g].b, d);
							i && this.g.xa(i[Mb], i.b, d);d && this.g[t](d, f);
							g = d ? d.q() : f;this.yc(this.la.line.ma, c, g)
						}
						this.Yj(a, b)
					} else this.Sm(a, b, n)
				}
		...
		V.Sm = function(a, b, c) {
			...
			if (0 >= a[dd]) this.ak(d), this.Yj(a, b);
				...
				if (c = c.oe(this.g)) {
					...
					g && this.g.xa(g[Mb], g.b, e);e && this.g[t](e, c);
					e = e ? e.q() : c;this.yc(this.la.line.ma, d, e)
				}
				this.Yj(a, b);this.Ia.z && a.z && this.Ia.ae == Ei && c && this.zc(c, {
					mouseover : wm,
					mousemove : nn,
					mouseout : xm
				}, {
		...
		V.Bp = function(a, b, c, d, e) {
			if (c && c.i && !c.ud) {
				...
				if (f) {
					...
					if (j || m)
						i = this.g.ja();
					j && this.g.Zj(j.x, j.y, j.Xb, j.b, i);i && this.g[t](i, f);
					if (m)
						for (j = 0; j < m.Ca[I]; j++) this.g.Zj(m.x, m.y, m.Ca[j].Xb, m.Ca[j].b, i);
					f = i ? i.q() : f;this.yc(e, g, f)
				} else if (this.ak(g), 0 == a[dd]) return;
				c.K && this.wh(c.K, b, d);c.Ue && this.lm(c.Ue, a, b, d);c.i.Wc && this.Lm(a, b, d, c.i.Wc);this.Ia.z && a.z && (this.rj[g] = {
					Hb : c.i,
		...
		V.Mo = function(a, b, c, d) {
			if (c && c.i) {
				...
				e = Hu([ vh, b, d ]);this.yc(this.la.candlestick.ma, e, g.q());c.K && this.wh(c.K, b, d);this.Ia.z && a.z && (this.vj[e] = {
					rect : c.i[vc],
					tb : c.i.tb,
					$ : b,
					Sa : d
		...
		V.Ms = function(a, b, c, d, e) {
			a = a == Gj ? [ d, 1 ] : [ 1, d ];return this.g.ne(s.min(b, b + a[0]), s.min(c, c + a[1]), s.abs(a[0]), s.abs(a[1]), new wt({
				fill : e
			}))
		};
		V.Lm = function(a, b, c, d) {
			...
			for (var e = this.g.ja(), a = a.hc.jg, f = 0; f < d[I]; f++) {
				...
				if (!(i[zc] == Cg || i[zc] == Ak)) {
					...
					else if (0 == g[w] || 0 == g[Q]) i = new Et, i[rb](g[C], g.top), i.G(g[C] + g[w], g.top + g[Q]), this.g.xa(i, j, e);else this.g[t](e, this.g.ne(g[C], g.top, g[w], g[Q], j))
				}
			}
			if (!e.Mg()) return l;
			b = Hu([ Xj, b, c ]);
			e = e.q();this.yc(this.la.interval.ma, b, e);return e
		};
		V.Hr = function(a, b) {
			var c = this.g,
				d = a.a.top,
		...
		V.il = function(a, b) {
			for (var c in b.e) {
				...
				if (fv(b.e[c], qq({
					...
					for (var e in b.e[c].c) b.e[c].c[e].K && this.Mk(ea(c), ea(e)), this.ao(d, ea(c), d.c[e], ea(e));else {
			...
			for (var c in b.e) {
				...
				if (fv(b.e[c], qq({
					...
					for (var e in b.e[c].c) {
						var f = new ju(2);
						f.Lb(0, d.c[e]);f.Lb(1, b.e[c].c[e]);
						f = f[ad]();this.ao(d, ea(c), f, ea(e))
				}
		...
		var Av = [ "#EFE6DC", "#D48265" ],
			Bv = [ "#DC3912", "#EFE6DC", "#D48265" ];
		zv[K].lt = function(a) {
			...
			c = -b - 2;
			b = -b - 1;return st(this.Ne[b], this.Ne[c], (a - this.Zd[c]) / (this.Zd[b] - this.Zd[c]))
		};
		function Cv(a, b) {
		...
		Jv[K].mt = function(a) {
			...
			a = this.qw[ed](a);
			a = pr(a, this.Uf[O], this.Uf.end);return s[z](s[Ib](this.dq + (a - this.Uf[O]) / this.eq * (this.pw - this.dq)))
		};
		var Kv = {
			sy : Jf,
			Iy : Sf,
		...
		function Lv(a) {
			...
			case Jf:
				...
				return 6E4;case Cf:
				return 36E5;case wf:
				return 864E5;case Yf:
				return 6048E5;case Mf:
				return 2629746E3;case Rf:
				return 7889238E3;case ag:
				return 31556952E3;default:
		...
		ya(Pv[K], function(a) {
			a /= this.Ti;return (1 == s.abs(s[z](a)) ? this.Rw : this.lq)[rc](a)
		});
		function Qv() {
			this.kq = new Date;this.Dg(Jf)
		}
		Qv[K].Dg = function(a) {
			switch (a) {
			case ag:
			...
			this.kq[Qc](a);return this.Qd[rc](this.kq)
		});
		function Rv() {
			this.Ql = l;
			this.Rf = [];
		...
		V = Rv[K];
		V.lu = function(a) {
			this.Pl = a;return this
		};
		V.iu = function(a) {
			this.Ql = a;return this
		};
		V.ju = function(a) {
			this.ph = a;return this
		};
		V.ku = function(a) {
			this.Ke = a;return this
		};
		V.mu = function(a) {
			a = av(op(a) ? a : 3);
			this.Rf = [ Ov(a, s.pow(10, 15), Pf, Pf), Ov(a, s.pow(10, 12), Vf, Vf), Ov(a, s.pow(10, 9), rf, rf), Ov(a, s.pow(10, 6), If, If) ];return this
		};
		V.gu = function() {
			var a;
		...
		V = bw[K];Ma(V, function() {
			this.m++;return this[H]()
		});
		V.Ya = function() {
			this.m--;return this[H]()
		};Ea(V, function() {
			...
			this.m = s[B]((a - this.fh) / this.gh);return this[H]()
		});sa(V, function(a) {
			this.m = s[db]((a - this.fh) / this.gh);return this[H]()
		});qa(V, function(a) {
			this.m = s[z]((a - this.fh) / this.gh);return this[H]()
		});
		V.Yu = function(a) {
			if (1 <= a) return 1;
			var b = a[ac](),
			...
			b = b[sb](me);-1 != b && (a -= c - 1 - b);return s.pow(10, -a)
		};
		function cw(a, b, c, d) {
			this.I = a;
			this.qc = b;
		...
		V.fl = function(a, b, c, d) {
			...
			1 == e[I] && (b = (new bw(d / 10))[B](c), b != e[0] && e[v](b));return e
		};
		function dw(a) {
			this.zv(a);
			this.dv = a[hb]();
		...
		V.zv = function(a) {
			var b = a[I];
			0 == b && h(r("Multiplier is empty."));1 > a[0] && h(r("Multipliers first value is too low."));10 <= a[b - 1] && h(r("Multipliers last value is too high."));
		...
		ew[K].gl = function() {
			var a = this.Fa.pe(),
				...
				d = this.Fa.pa(0);
			d >= a && d <= b && (a = this.Fa.Mb(this.Fa.pa(0) + this.sl), c = s.max(c, a));return this.sd[db](c)
		};
		function fw(a, b, c, d) {
			this.Ri = a;
			this.Hl = b;
		...
		V.fp = function() {
			var a = s[B](this.m / this.td),
				b;
			b = 10 * (this.m + this.Vg - a * this.td) / this.Ci;0 == b && (b = 1);return Uv(b, a)
		};Ea(V, function() {
			this.m = s.abs(this.Va) + this.Ee;return 0 < this.Va ? this.fp() : 0 > this.Va ? -this.fp() : 0
		});Ma(V, function() {
			this.Va++;return this[H]()
		});
		V.Ya = function() {
			this.Va--;return this[H]()
		};
		ta(V, function(a) {
			...
			this[H]() != a && (c = this.Ci * a / Uv(1, Xv(s.abs(a))), this.Va += s[B](c) - b);return this[H]()
		});
		sa(V, function(a) {
			var b = this.Vg,
				c = Wv(s.abs(a));
			...
			this[H]() != a && (c = this.Ci * a / Uv(1, Xv(s.abs(a))), this.Va += s[db](c) - b);return this[H]()
		});
		qa(V, function(a) {
			var b = Wv(s.abs(a));
			...
			this[H]() != a && (b = this.Ci * a / Uv(1, Xv(s.abs(a))), this.Va += s[z](b) - this.Vg);return this[H]()
		});
		...
		hw[K].ai = function() {
			...
			b = Uv(1, Xv(s.abs(a)));b == a && (b *= 10);this.sd[db](b / s.abs(c - a));
		...
		function jw(a, b) {
			...
			s[z](c);
			this.fw = c;
			this.fc = new Date;this[B](0)
		}
		V = jw[K];Ea(V, function() {
			return this.fc[Vb]()
		});Ma(V, function() {
			var a = this.fc[Gc](),
				a = a + this.Yd;
			this.fc.setUTCMonth(a);return this[H]()
		});
		V.Ya = function() {
			this.fc.setUTCMonth(this.fc[Gc]() - this.Yd);return this[H]()
		};
		ta(V, function(a) {
			this.fc[Qc](a);1 < this.Yd && (this.fc.setUTCMonth(this.fc[Gc]() - (this.fc[Gc]() + 12 - this.fw) % this.Yd % 12), 12 < this.Yd && this.fc.setUTCFullYear(this.gw[B](this.fc.getUTCFullYear())));this.fc.setUTCDate(1);this.fc.setUTCHours(0, 0, 0, 0);return this[H]()
		});sa(V, function(a) {
		...
		V.Ya = function() {
			...
			this.m = Wv(a);return this[H]()
		});sa(V, function(a) {
			this.m = Xv(a);return this[H]()
		});qa(V, function(a) {
			var b = Uv(1, Xv(a)),
				c = b / 10;
			this.m = s[z](Vv(a - c < b - a ? c : b));return this[H]()
		});
		function lw(a) {
			...
			this.Gf = this.Fb[this.Fb[I] - 1];this.Ta[z](1);
			this.zo = this.Gf * this.Ta[oc]();
			this.Gt = this.Gf + (this.zo - this.Gf) / 2;this.Sb(2)
		}
		V = lw[K];
		V.Sb = function(a) {
			this.dl = 1 == a || 4 == a;
		...
		sa(V, function(a) {
			...
			this.Fb[this.m + 1] - a <= a - this.Fb[this.m] && this.m++;return this.Fb[this.m]
		});
		Ma(V, function() {
			this.dl ? (this.Ta[oc](), 1 == this.Rc && this.Ta[H]() == this.zi && this.Sb(2)) : (this.m++, this.m == this.Fb[I] && (this.Sb(4), this.Ta[z](1), this.Ta[oc]()));return this[H]()
		});
		V.Ya = function() {
			this.dl ? (this.Ta.Ya(), this.Rc == this.Gf && 1 == this.Ta[H]() && this.Sb(3)) : (this.m--, -1 == this.m && (this.Sb(1), this.Ta[z](this.zi), this.Ta.Ya()));return this[H]()
		};
		function mw(a, b) {
			var c = W(b) ? b : 1,
				a = (new lw)[z](a);
		...
		function ow(a) {
			var b = Wv(a),
				a = a / Uv(1, b),
				b = s.abs(s[z](a) - a);
			0 != b && 1.0E-10 > b && (a = s[z](a));return s[B](a)
		}
		;
		function rw(a, b, c, d, e, f, g, i, j) {
			...
			this.Rk = j;
			this.qt = Lv(a);
			this.ti = Lv(b);this.Qb.Dg(this.to)
		}
		V = rw[K];
		V.Mt = function(a) {
		...
		V.Iw = function() {
			...
			var c;
			c = this.Qb[zb](b);
			c = new Zv(b, this.I.Hd(), k, k, n, c, 1);this.Qb.Dg(this.to);
			...
			d && b < a && this.Ht(g,
				f, b);this.Rk && (this.Jt(c, g, this.qc), g[v](c));return 2 > this.Lt(g) ? this.It() : this.Nt(g) ? this.Pt(g) : g
		};
		V.Ht = function(a, b, c) {
			var d = this.Qb[zb](c),
		...
		V.It = function() {
			var a = this.Qb[zb](this.I.me()),
				...
				a = a + ke + b,
				b = [];
			this.Ku(a, this.I) || b[v](aw(NaN, this.I.pe() + this.I.Hd() / 2, a));return b
		};
		V.Ku = function(a) {
		...
		V.oc = function(a, b) {
			...
			this.r = [];
			this.M = p;
			this.Q = -p;ya(this, a.hi(this.A(fj)));
		...
		V.ss = function(a, b, c) {
			...
			if (this.M == this.Q)
				0 == this.M ? (this.M = -1, this.Q = 1) : 0 < this.M ? (this.M /= 2, this.Q *= 2) : (this.M *= 2, this.Q /= 2);
		...
		function xw(a, b, c, d, e, f) {
			this.lg = c;
			this.k = b;La(this, d);Aa(this, b.ia(this.A(po), ru, e));
		...
		V.Zf = function(a) {
			...
			if (ip(this.Ac) || this.Ac == Pi) {
				...
				this.Ac = this.Lq);this[F] == Ho && this.Ac == Pi && this.et()
			}
		};
		V.On = function() {
		...
		V.xf = function(a, b, c, d) {
			...
			this.ob = c + b * this[Wa];
			if (this[F] == Ho)
				0 == this.j.cb ? this.j[sc] == yw ? this.Mr(a) : this.Nr(a) : this.Lr();else {
				var e;
				if (this.Ac == Pi) {
					if (this.J.min == -p)
				...
				this[F] == Bh && (e = s.max(1, e - 1));this.Gq && (e = s.min(e, s[B]((b + 1) / 2)));
				b = this.uh / 1.618 / e;
		...
		V.Lr = function() {
			this.Y(this.j.U(this.xh));this.j.ss(this.hj, this.gj, this.Ac == Sl || this.On());
			if (this.On()) {
				if (this.J.min != -p)
					this.j.M = this.J.min;
				else if (this.J.max != p)
		...
		V.ck = function() {
			...
			this.th = a;
			if (W(this.xh))
				a = this.j.U(this.xh);else var c = this.j.U(this.j.Jk()),
					a = pr(c, a, b);
			this.V = this.wd(a) ? {
				fa : this.j.Vh(a),
				u : this.Aa(a)
		...
		V.Nr = function(a) {
			this.Y(this.hj);this.Y(this.gj);
			if (this.Ac == Sl) {
				var b;
				b = new pt(this.j.M, this.j.Q);
				if (b[O] != b.end) {
					(!ia(b[O]) || !ia(b.end)) && h(r("Range must be finite."));b[O] > b.end && h(r("Range start must be less or equal to end."));
					var c = 0.1 * (b.end - b[O]);
					b = new pt(0 > b[O] ? -qw(-b[O], c) : nw(b[O], c), 0 > b.end ? -nw(-b.end, c) : qw(b.end, c))
				}
				this.Y(b[O]);this.Y(b.end)
			}
			this.ck();
			var d = this.jk(a),
		...
		V.Rr = function(a) {
			...
			}), a.za(this.A(lj)) && b.mu(5));return b.gu()
		};
		V.Y = function(a) {
		...
		V.Or = function(a) {
			a = this.Uu(a);return !W(a) ? l : this.j.Vh(a)
		};
		V.Tm = function(a) {
		...
		function zw(a, b, c, d) {
			...
			this.tm = this.sm = this.qj = this.pj = this.cf = this.af = l;this.xj()
		}
		V = zw[K];
		V.xj = function() {
			function a(a, b, d) {
				if (c[mb]() <= a) return S;
				var e = c[Fb](a);
				b && !(0 <= Lp(d, e)) && h(r("Column " + a + " must be of type " + d[cd](xe)));!b && 0 <= Lp(d, e) && h(r("Column " + a + " cannot be of type " + d[cd](xe)));return e
			}
			var b = this.h,
				c = this.D,
				d = c[mb]();
			3 > d && h(r("Data table should have at least 3 columns"));a(this.uj, k, [ pn ]);
		...
		V.jr = function(a, b) {
			...
			if (this.zd == gl) {
				...
				if (f && 0 < f[I]) {
					...
					var f = c.Mc(bi),
						g = c.Mc(ai);
					W(f) && W(g) && f > g && h(r("colorAxis.minValue (" + f + ") must be at most colorAxis.maxValue (" + g + fe));(d = ut(d, f, g)) && (e = [ d[O], d.end ])
				}
				d = c.R(ei);
				d = c.R($h, d);
				c = Cv(e, d);
			...
			f = this.qj;
			c = d.da(Qm);
			e = d.da(Om);c > e && h(r("sizeAxis.minSize (" + c + ") must be at most sizeAxis.maxSize (" + e + fe));
			var g = d.Mc(Rm),
				i = d.Mc(Pm);
		...
		V.Ii = function(a, b, c) {
			a = s[db]((this.Ud[I] - a) / (b * c));return 2 > this.Ud[I] || 2 > a
		};
		...
		V.Ph = function(a) {
			function b(b) {
				b = a(b[x], c)[w] * e + d * f;return s[db](b)
			}
			var c = this.Ra,
				d = c[M],
				e = s.sin(this.bi),
		...
		function Jw(a, b, c) {
			...
			c = Tu(s.log(a), d, c);
			a = c[0];return a <= d[I] - 1 ? b[a] : Hw(Lw(s.exp(c[1])), Jp(b), s[z])
		}
		function Mw(a) {
			a = Tp(a, function(a) {
				return 0 != a
		...
		function Ow(a) {
			var b = [],
				a = s[B](a / 1E3);
			b[v](s[B](a / 3600));b[v](s[B](a / 60) - 60 * b[0]);b[v](a - 3600 * b[0] - 60 * b[1]);return b
		}
		...
		V.oc = function(a, b) {
			...
			var c = a.fi(this.A(gj)),
				d = [];
			d[v](c.millisecond);d[v](c.second);d[v](c.minute);d[v](c.hour);d[v](c.day);d[v](c.month);d[v](c.year);
			this.zl = Pw([ d, gq(this[zb], d[I]), this.zl ])
		};
		function Pw(a) {
			a = hq[Uc](l, a);return Op(a, function(a) {
		...
		V.pu = function(a) {
			a = this.zl[Mw(a)];return new google[wc].DateFormat({
				pattern : a
			})
		};
		...
		function Ww(a, b, c, d, e, f, g) {
			for (var i = [], j = b - a, m = d + f, o = s[db](j / (1 - (c + e)) / g), j = s[B](j / (1 - m) / g); o <= j; ++o) {
				var m = o * g,
					...
					y = 1;
				0 < b && 0 > a ? 1 < g && (q = s[db](q / o) * o, u = s[B](u / o) * o, y = o) : 0 <= a ? q = s.max(0, q) : u = s.min(-m, u);0 <= u - q && i[v]({
					Dv : o,
					Cv : y,
					Bv : q,
					Av : u
		...
		V.kl = function(a, b, c) {
			...
			this.M = s.min(c.Kb, a);
			this.Q = s.max(c.Lc, b);a:
			if (a = this.Pk ? d / this.Pk : d, 0 == a)
				a = 0;else {
				a = s.abs(a);
				for (b = 0; 16 > b; ++b) {
		...
		function Aw(a) {
			var b = {};
			va(b, a[tb] || a);var c = mt(b[tb]);
			c == U ? (b.wf = a.darker || c, b.si = a.lighter || c) : (c = it(c), b.wf = a.darker || gt(lt([ 0, 0, 0 ], c, 0.25)), b.si = a.lighter || gt(lt([ 255, 255, 255 ], c, 0.25)));return b
		}
		;
			...
			if (this.ic == ol) {
				...
				this.Re = q < i ? [] : Op(this.r, function(b, c) {
					var d = 0 == this[ic] ? Ni : fn,
						e = Eh;
					this.Kq == lh && (0 == c && (e = 1 == this[Wa] ? fn : Ni), c == this.r[I] - 1 && (e = 1 == this[Wa] ? Ni : fn));return this.Fn(a, b, o, q, d, e, 0)
				}, this)
			}
		};
		V.hn = function(a) {
		...
		function fx(a, b, c, d) {
			...
			this.h.jc = b.ia(Yi, Bu, ri);d.jc == xh && d.N != T && h(r("Focus target " + d.jc + " is not supported for the chosen chart type."));
			...
			this.h.im = this.k.za(Jm, n);this.os()
		}
		V = fx[K];
		V.ps = function() {
			var a = this.h,
		...
		function gx(a, b) {
			for (var c = [], d = [], e = l, f = 0, g = 0; g < a[mb](); ++g) {
				...
				j == Fi && (0 < f && h("Unexpected domain column (column #" + g + fe), e = {
					w : {},
					dataType : i
				}, d[v](e));j == pi && 0 == f && (f = b(c[I]), e = {
					type : f,
					dataType : i,
					w : {}
				}, c[v](e), f = f == wh ? 4 : 1);j == pi && (f--, i != e[Fc] && h("All data columns of the same series must be of the same data type"));
				e.w[j] = e.w[j] || [];e.w[j][v](g)
			}
		...
		V.Ur = function(a, b, c, d) {
			...
			0 != a.qe[I] % 2 && h(r("Stick-intervals must be defined by an even number of columns"));0 != a[$c][I] % 2 && h(r("Area-intervals must be defined by an even number of columns"));
			for (m in g)
		...
		V.os = function() {
			...
			switch (a.N) {
			case T:
				Ca(a, this.k.ia(nl, uu, S));a[Qb] || h(r("Unspecified orientation."));this.Z = [];this.Ma = [];this.La = [];var b,
					c,
					d,
					e;
				switch (a[Qb]) {
				case Gj:
					d = Dw;e = this.Ma;b = ex;c = this.La;
					break;case Ko:
				...
				this.Z[0] || h(r("Axis #0 must have some data column associated with it."));this.sa = new d(a, this.k, [ Gi ],
					0, this.Ps(), Nk);e[v](this.sa);
				break;case rm:
			case oh:
		...
		V.eu = function(a) {
			switch (a) {
			case Cg:
				return 1 < this.h.v[I] ? Bh : xh;case Ak:
			case Pg:
			case hn:
			case wh:
				return xh
		...
		V.Qs = function() {
			...
			case rm:
			case oh:
				a.fe == pn && h(r("X values column cannot be of type string"));var b = a.mf[0];
				b == pn && h(r("Data column(s) cannot be of type string"));var c = this.Ma[0],
					d = this.La[0];
				c[F] != Ho && h(r("The x-axis must be of type value"));c.oi(a.fe, this.k);d[F] != Ho && h(r("The y-axis must be of type value"));d.oi(b, this.k);
				break;case T:
				b = this.sa;b[F] == Ho && (a.fe == pn && h(r("Domain column cannot be of type string, it should be the X values on a continuous domain axis")), b.oi(a.fe,
					this.k));
			...
			for (var a = this.h, b = this.D, c = this.Ma[0], d = this.La[0], e = 0; e < b[dc](); e++)
				for (var f = 0; f < a.e[I]; f++) {
					var g = a.e[f],
						...
						g = c.j.od(g),
						i = d.j.od(i);
					W(g) && c.yf(g);W(i) && d.yf(i)
			}
		};
		V.tn = function() {
			var a = this.h;
			this.or();a.Vc && Mp(this.Z, function(a) {
				a.Y(0)
			});
			if (a.N == T) {
				this.pr();this.sa[F] == Ho && (this.sa.uf(), this.sa.Zf(this.k));
			...
			a.gb.bars && this.$m(Pg);a.gb.steppedArea && this.$m(hn);a.gb.candlesticks && this.kr();a.gb.line && (this.mr(), this.an());a.gb.area && this.ir();a.gb.scatter &&
			(this.nr(), this.an());a.gb.bubbles && this.Oh.jr(this.Ma[0], this.La[0]);
			a.ta = Op(this.Ma, function(b) {
				return b.xf(a, b)
			});
			a.Ka = Op(this.La, function(b) {
				return b.xf(a, b)
			});this.lr();this.tr();a.N == T && a[Qb] == Gj && this.sr();
			b = a.f[fc];
			if ((b == hm || b == gk) && !this.xm())
				if (a.f.pb = new hs(a.a.top, a[w] - a.f.t[M], a.a[P], a.a[R] + a.f.t[M]), a.f.pb[R] < a.f.pb[C])
					a.f.pb = l;
			this.ur()
		};
		V.or = function() {
		...
		V.ru = function(a) {
			...
			d.ke(b.v[I], 1);Mp(b.v, function(a, b) {
				Mp(e, function(a, e) {
					var f = this.Z[a.Ja],
						o = a.w[A][0],
						q = c[H](b, o),
					...
					if (ip(q)) a.c[v](l);else {
						...
						this.of(f, a, b);a.c[v](f)
					}
				}, this)
			}, this);Mp(this.Z, function(a) {
				a.Wm()
			})
		};
		V.kr = function() {
			...
			c.ke(a.v[I], 1);Mp(a.v, function(a, f) {
				Mp(d, function(a, d) {
					var e = a.w[A],
						m = this.Z[a.Ja];
					c.ke(0, d + 1);
				...
				for (var e = 0; e < a.e[I]; e++) {
					...
					if (f[F] == Ak) {
						...
						if (W(i)) {
							var j,
								m;
							c[F] == Ho ? (j = b[H](d, 0), j = c.j.U(j), c.Y(j), m = c.wd(j)) : (j = d, m = k);m && g.Y(i);
							g = this.Qh(f, d, 0, m);
							g = {
								hb : {
									Bd : d,
				...
				for (var e = gq(0, this.Z[I]), f = Yp(e), g = Yp(e), i = 0; i < a.e[I]; i++) {
					...
					if (j[F] == Cg) {
						...
						if (W(D)) {
							...
							var G;
							c[F] == Ho ? (y = b[H](d, 0),
							G = c.j.U(y), c.Y(G), y = c.wd(G)) : (G = d, y = k);y && o.Y(Y);
							o = this.Qh(j, d, g[m], y);a.Vc && (g[m] = Y);
							m = {
								Wb : G,
								nf : Y,
								Bd : d,
		...
		V.of = function(a, b, c) {
			...
			if (1 > d) switch (a.Hg = d, b[F]) {
				...
				case Cg:
				case rm:
					a.b = this.rk(f, k);a.Xb = s.max(g - a.b.wo() / 2, 0);
					break;case Pg:
				case hn:
					a.b = this.rk(f, n)
			}
		...
		V.ut = function(a, b) {
			var c = this.D,
				...
				e = a.w[A];
			if (a[F] == wh)
				e = c[Xc](b, e[0]) + kd + c[Xc](b, e[3]) + ie + c[Xc](b, e[1]) + kd + c[Xc](b, e[2]);else {
		...
		V.an = function() {
			...
			var e = this.h,
				...
				i = Z(function(a, b, c) {
					f.Y(c.Wb);b.Bm && this.Z[a.Ja].Y(c.nf)
				}, this),
				j,
				m,
				o;
		...
		V.At = function(a, b) {
			var c = this.h,
				d = b.o;
			if (d.kf) return k;
			d = nu(d);return !d ? k : a.ic == Pj && !(new hs(c.a.top, c.a[R], c.a[P], c.a[C]))[Tc](d) ? n : k
		};
		V.cu = function(a, b) {
			var c = this.h;
			if (a.ic != Pj) return k;
		...
		V.sr = function() {
			...
			Mp(this.h.v, function(d, e) {
				var f = [],
					g = [];
				Mp(b.Zc, function(a) {
					a = this.Jm(e, a.w);Zp(f, a.Mj);Zp(g, a.tb)
				}, this);
				if (f[I] || g[I]) {
					var i;
		...
		V.fs = function(a) {
			...
			function c(a, b) {
				...
				e[a].tb[v](new wr(b[C], b.top));e[a][P] && e[a][P][v](new wr(b[C] + b[w], b.top + b[Q]))
			}
			function d(a) {
				a = f[a][zc];return a == Cg || a == Ak
			}
			var e = {},
				f = a.hc.jg;
			a.hc.fk = [];
		...
		V.es = function(a) {
			switch (a[F]) {
			case rm:
				return Z(this.Fw, this, a);case sh:
				return Z(this.Cw, this, a);case Ak:
				return Z(this.Ew, this, a);case Pg:
				return Z(this.Bw, this, a);case hn:
				return Z(this.Gw, this, a);case wh:
				return Z(this.Dw, this, a);case Cg:
		...
		V.Dw = function(a, b) {
			...
			oa(d, 2);xa(d, d[C] + (c[w] - (c[w] % 2 ? 3 : 2)) / 2);b.dr && (Ua(c, c[Q] - 2), oa(c, c[w] - 2), xa(c, c[C] + 1), c.top += 1);Ua(c, s.max(c[Q], 2));oa(c, s.max(c[w], 1));return {
				rect : c,
				tb : d
			}
		};
		V.Gw = function(a, b) {
			...
			var d = this.sa,
				...
				f = this.nd(f, i),
				i = [];
			this.k.za(hi, k) && W(b.Aj) && (c = this.nd(g, c.Aa(b.Aj)), i[v](c));i[v](e);i[v](f);return {
		...
		V.Dl = function(a, b, c, d) {
			...
			e = s[B](b + d);
			a = this.nd(s[B](b - d), a);
			e = this.nd(e, c);return new js(s.min(a.x, e.x), s.min(a.y, e.y), s.abs(e.x - a.x), s.abs(e.y - a.y))
		};
		V.Aw = function(a, b) {
			var c = this.Z[a.Ja],
				d = c.j.U(c.V.fa),
		...
		V.rk = function(a, b) {
			var c = a[Dc]();
			c.Qg() && c.O != Ud ? (c.Kk(new vt(Tl, c.O)), !c.pd() && b && (c.gc(c.O), c.ee(1))) : c.pd() && c.co(oi);return c
		};
		V.zs = function(a, b) {
			var c = a[Dc]();
			c.ee(c.H * b);return c
		...
		V.Wq = function() {
			...
			a > this.Nl && h(r("Not enough space for labels. Need: " + a + " got: " + this.Nl));this.Le.sort(function(a, b) {
				var c = a.Fl,
					d = b.Fl;
		...
		V.Xq = function(a) {
			...
			c = b[d];
			b = b[d + 1];return c.i.y + (a - c.hb.Wb) / (b.hb.Wb - c.hb.Wb) * (b.i.y - c.i.y)
		};
		V.us = function(a, b, c) {
		...
		V.Pn = function(a, b) {
			for (var c = this.ab + this.Dd, d = this.oa[R] - this.oa[C] - c, e = this.W[M], f = s[z](e / 1.618), g = s[z](e / 3.236), f = e + f, e = e + g, g = [], i = s[z](this.oa.top), j = s[z](this.oa[C]), m = 0; m < b[I]; m++) {
				...
				if (0 != q) {
					...
					u.P.b = o.b[Dc]();this.W.$a && u.P.b.gc(this.W.$a, 1);
					var y = j + c;
					u.B = k;
					u.z = o.z;
		...
		V.Ko = function(a, b, c) {
			for (var d = this.oa[R] - this.oa[C], e = this.ab + this.Dd, f = s[z](1.618 * this.W[M]), g = [], i = 0, j = s[z](this.oa.top), m = 0; m < a[I]; m++) {
				...
				D.z = o.z;
				D.P = {};
				D.P.b = o.b[Dc]();this.W.$a && D.P.b.gc(this.W.$a, 1);
				D.P.S = new js(i, j, this.ab, this.ab);La(D, o[ic]);g[v](D);
				i += y + e + f
			}
			a = this.oa[C];!this.ad && c && (a += s[B]((d -
				(i - f)) / 2));
			for (m = 0; m < g[I]; m++) {
				D = g[m];xa(D.P.S, D.P.S[C] + a);
		...
		function mx(a, b, c, d, e, f, g) {
			...
			for (var q; q = nx(a, i, j, g, m, n), q.Vk;)
				for (var u = q.Ed, y = 0; y < o[I]; y++) {
					var D = o[y];
					if (u[D.Ef].Vk) {
						0 < D.we ? D.we-- : 0 < D.Nd && (D.Nd--, 0 == D.Nd && (Wp(m, D), Kp[bd][N](o, y, 1)));break
					}
			}
			return q.Ed
		}
		...
		V.Wr = function() {
			...
			b = Yu(d, b);return b[I] > e ? (e = a.a[P] + b[e], new hs(e - c, a.a[R], e, a.a[C])) : l
		};
		V.Sj = function() {
			var a = this.h,
				b = a.a,
		...
		V.Yr = function(a, b, c, d) {
			...
			for (L = 0; L < f[dc](); ++L) {
				...
				aa.z = this.k.za(Lf + pe, k);e.e[v](aa);this.k.za(Lf + we, rl || u) && e.$c[v]({
					id : jb,
					text : Da,
					b : new wt({
						fill : ch[tb]
			...
			f = l;0 < X && (Da = y, f = this.Um(l, 1 - X / Y, 1, X, S + X, Da, k, a, b, c, D, d, 0, m, j, o, g, i), u || e.$c[v]({
				text : Da,
				b : new wt({
					fill : g[tb]
				}),
		...
		V.Um = function(a, b, c, d, e, f, g, i, j, m, o, q, u, y, D, Y, L, X) {
			...
			G.Xc = 1 == aa;
			if (G[x])
				if (G.Xc) G.oj = yr(i, new wr(e / 2, g / 2)), G.nj = k;else {
					D = j - g;
					aa = m - g;
					e = G.Bh;
					e = new lq(e[w] / D, e[Q] / aa);
					g = new lq(2 / D, 2 / aa);
					y = lv((d + f) / 2 + s.PI, 1, 1);b:{
		...
		V.Xr = function(a, b, c) {
			for (var d = this.h, e = b.ea.ka, f = b.ea.ua, g = b.ea.Hb, i = this.k.ia(kk, zu, Bl), j = s.PI * (3 * (e + f) - s[Ib]((3 * e + f) * (e + 3 * f))), m = [], o = [], q = 0; q < d.$c[I]; ++q) {
				var u = d.$c[q],
					y;
				y = u[ic] != l ? d.e[u[ic]] : d.ea.zj;var D = s.max((e + y.$f) / 2, 0.75 * e),
					Y = s.max((f + y.Ye) / 2, 0.75 * f),
					L = (y.ca + y.ga) / 2,
					X = 360 * (ur(e - D, f - Y) / j),
					G,
					aa;
				2 * X < y.ca - y.ga ? (G = y.ga + X, aa = y.ca - X, 180 > L ? aa = s.min(aa, 180) : G = s.max(G, 180)) : aa = G = L;var na = function(a) {
		...
		function sx(a, b, c, d, e) {
			...
			this.D = l;
			this.k = b;
			this.ra = c;var f = this.h = {};
			f.tc = c;oa(f, d);Ua(f, e);
			f.N = b.ia(po, ou, U);
			f.Tc = b.Hc(cj);
			...
			f.ae = b.ia(Vj, Au, yi);
			f.z = this.k.za(Mi, k);
			f.lj = this.k.za(on, k) || a.getColumnProperty(0, jm) == Fi;this.xj();f.ae == Ei && (!f.gb || f.gb.line != f.e[I]) && h(r("DIVE interactivity model is only supported when all series are of type line."))
		}
		V = sx[K];
		V.Gg = function() {
			return this.h
		...
		V.xj = function() {
			...
			this.Nj = new kx(a, this.k);this.bs();a.f.pb && this.Nj.as()
		};
		V.qi = function(a, b, c) {
			var d = NaN,
				e = a.Mc(b);
			W(e) ? d = e : (a = a.hi(b), W(a) && (a = yp(a), b = a[I] - 1, 0 <= b && a[sb](Yd, b) == b && (d = a[I] - 1, b = a, 0 <= d && d < a[I] && (b = a[Zb](0, d) + a[Zb](d + 1, a[I] - d - 1)), a = Gp(b), d = c * a / 100)));return d = s[z](pr(d, 0, c))
		};
		V.$r = function() {
			var a = this.h,
				b = this.jj,
		...
		V.mo = function(a, b, c, d) {
			ka(b) && (b = d());ka(a) && (a = s[z]((c - b) / 2));
			b = s.min(a + b, c);return {
				start : a,
				end : b
			}
		};
		...
		function tx(a, b) {
			...
			this.rf = this.Fd = l;this.vu();
			this.Rh = this.Wj = l;this.uu()
		}
			...
			if (a.L && b.L) {
				...
				if (a.kb && b.kb) {
					...
					for (var m = g.kb, o = c.kb, q = 0; q < m[I]; q++) {
						m[q] = sq(m[q]);
						o[q] = sq(o[q]);var u = m[q];
						u.u = j(u.fa)
					}
				}
				if (a[x] && b[x]) {
					pa(g, Yp(g[x]));pa(c, Yp(c[x]));
					m = g[x];
					c = c[x];vx(m);vx(c);
				...
				pa(g, Np(b[x], function(a, b) {
					return W(y.og[b])
				}));pa(c, Yp(f[x]));vx(f[x]);vx(g[x]);vx(c[x])
			}
			return [ f, g ]
		}
		...
		V.bt = function() {
			...
			if (a && b) {
				...
				this.Ab.v = f;this.mi(g, function(a, b) {
		...
		V.at = function(a, b) {
			...
			if (c && d)
				if (0 == c[I] || 0 == d[I]) this.Ab.v = [], this.mi([], function() {
					...
					this.Ab.v = m;this.mi(o, function(a, b) {
						return a[b]
					})
			}
		};
		...
		function zx(a, b, c) {
			if (a !== b)
				if (a && a[sc] == wt && b && b[sc] == wt)
					...
					a = mp(a) && mp(b) ? Ax(a, b, c) : op(a) && op(b) ? a * (1 - c) + b * c : l;
			return a
		}
		function Ax(a, b, c) {
			if (!a) return b;
		...
		function Bx(a, b, c, d, e) {
			b = !e || (c ? b >= c.top && b <= c[P] : n);return (!d || (c ? a >= c[C] && a <= c[R] : n)) && b
		}
		...
		function Dx(a, b) {
			...
			for (var i = 0 > b, o = Ex(e[0], e[1], b), j = e[I] - 2, f = 1; f <= j; f++) {
				...
				if (mp(q)) {
					...
					u = q == p;
				o = u && q != p ? q : Fx(Gx(e[f], e[f - 1]), o);c.ac(Hx(d[f - 1], o));u || (o = 180 - 180 * s[Db](o.x - e[f].x, o.y - e[f].y) / s.PI, q = Fx(Gx(e[f], e[f + 1]), m), c.jb(e[f].x, e[f].y, s.abs(b), s.abs(b), o, 180 - 180 * s[Db](q.x - e[f].x, q.y - e[f].y) / s.PI, i));
				o = m
			}
			g && c[Ac]();return c
		}
		function Hx(a, b) {
			...
			case Ak:
				c[A].x = b.x;c[A].y = b.y;
				break;case ji:
				c[A].x = b.x;c[A].y = b.y;var d = b.x - a[A].x,
					e = b.y - a[A].y;
				c[A].Cb += d;c[A].Db += e;c[A].gd += d;c[A].hd += e
			}
			return c
		}
		function Ex(a, b, c) {
		...
		function Gx(a, b) {
			var c = (a.x - b.x) / (b.y - a.y),
				d;
			ia(c) ? d = a.y - c * a.x : (c = p, d = a.x);return {
				Oe : c,
				Gc : d
			}
		}
		...
		V.bm = function(a, b) {
			...
			a == mm ? this.Ub[b[0]] = 1 : a == fi ? this.Tb[b[0]] = 1 : this.Vb[S + (b[0] + ge + b[1])] = 1;return k
		};
		V.addRow = function(a) {
			return this.bm(mm, [ a ])
		};
		...
		V.pk = function(a, b) {
			var c = this.Vl(a);
			b && this[Pb]();
			c ? this.removeRow(a) : this.addRow(a);return !c
		};
		V.Zs = function(a, b) {
			var c = this.Ul(a);
			b && this[Pb]();
			c ? this.removeColumn(a) : this.addColumn(a);return !c
		};
		V.En = function(a, b, c) {
			var d = this.fq(a, b);
			c && this[Pb]();
			d ? this.$w(a, b) : this.Yw(a, b);return !d
		};
		...
		Oa(Kx[K], function() {
			...
			a.X = mu(this.X);
			a.Ob = mu(this.Ob);
			a.f = mu(this.f);Ja(a, mu(this[gc]));return a
		});
		Kx[K].Od = function(a) {
		...
		function Nx(a, b, c, d, e, f, g) {
			...
			j = s[z](j + 2 * i / 1.618);
			g = s[z](g + 2 * i / 1.618);
			u = new lq(j, g);var j = d.x >= f.x ? 1 : -1,
				m = d.y > f.y ? 1 : -1,
				y = l,
			...
			if (!(g.p[C] >= d && g.p[R] <= c)) {
				j = tq(g);
				m = j.p[C];xa(j.p, f.x + -1 * (j.p[R] - f.x));Va(j.p, f.x + -1 * (m - f.x));
				...
				if (j.p[C] >= d && j.p[R] <= c) g.p = j.p, g.Eb = j.Eb;else {
					...
					g.p[R] > c && (xa(g.p, g.p[C] - (g.p[R] - c)), Va(g.p, c));g.p[C] < d && (Va(g.p, g.p[R] + (d - g.p[C])), xa(g.p, d))
				}
			}
			d = e.top + 5;
			e = e[P] - 5;
			if (!(g.p.top >= d && g.p[P] <= e)) {
				c = tq(g);
				j = c.p.top;
				c.p.top = f.y + -1 * (c.p[P] - f.y);Ra(c.p, f.y + -1 * (j - f.y));
		...
		V.Zn = function(a, b) {
			...
			if (b.d) {
				...
				b.Hk ? (this.xk(c, b.Hk), this.gi(c, b.lf, b[fb], k, a)) : b.lf ? this.gi(c, b.lf, b[fb], k, a, k) : this.gi(c, l, b[fb], n, a);
			return c
		};
		V.xk = function(a, b) {
			var c = Mx(b, this.Yk);
		...
		V.Rs = function(a) {
			a = a.i.Wf || a.i;
			a = new $(a[C] + (a[C] < this.qd.x ? 0 : a[w]), a.top + (a.top < this.qd.y ? 0 : a[Q]));this.Zo(a);return a
		};
		V.Ss = function(a) {
			a = a.i[vc];
			a = new $(a[C] + a[w] > this.qd.x ? a[C] + a[w] : a[C], a.top < this.qd.y ? a.top : a.top + a[Q]);this.Zo(a);return a
		};
		V.Ts = function(a) {
		...
		V.Js = function(a, b) {
			...
			case T:
				...
				case Pg:
				case hn:
					return this.Rs(c.c[b]);case Ak:
				case Cg:
					return this.eo(c.c[b], c);case wh:
					return this.Ss(c.c[b])
				}
			case rm:
			case oh:
				return this.eo(c.c[b], c);case Dl:
				return this.Ts(c)
			}
		};
		V.Zo = function(a) {
		...
		V.Yl = function(a, b, c) {
			...
			f = b.s.Xa;
			g = b.X.na;
			d = b.X.Xa;W(f) && this.Vj(a, e, f, c);
			if (W(d))
				this.eg(c, g, d).K = this.ge.Mh(g, d);
			e = b.f.s.lc;W(e) && this.Ds(a, e, c);
			e = b.s.Bb;W(e) && this.Cs(a, e, c);
			a = b.X.Bb;
		...
		V.Vj = function(a, b, c, d) {
			...
			if (f && !f.ud && f.i && (!qv(e) || 0 != e[dd] || rv(f, e))) {
				...
				case hn:
				case wh:
					e = f.i.Wf || f.i[vc] || f.i;f = new js(e[C], e.top, e[w], e[Q]);
				...
				case rm:
				case sh:
					d.gf = k;b.x = f.i.x;b.y = f.i.y;d.qb ? (e = d.qb, f = e.Xb + e.b.H / 2) : f = tv(f, e);
		...
		V.Sh = function(a, b, c, d) {
			...
			if (f && !f.ud && f.i && (!qv(e) || 0 != e[dd] || rv(f, e))) {
				...
				c = b.qb;
				a = At(a.bj, a.cj);
				d = 1;W(a) || (a = So, d = 0);switch (e[F]) {
				case Pg:
				case hn:
				case wh:
					c.b = xt[Dc]();c.b.gc(a);e[F] == wh && f.dm.O == a && c.b.gc(g.O);c.b.bg(d);c.b.ee(1);e = f.i.Wf || f.i[vc] || f.i;g = g.H;f = c.b.H;c.rect = new js(e[C] + g / 2 + 1.5 + f / 2, e.top + g / 2 + 1.5 + f / 2, e[w] - (g + 3 + f), e[Q] - (g + 3 + f));(0 >= c[vc][w] || 0 >= c[vc][Q]) &&
					delete b.qb;
					break;case Ak:
				case Cg:
				case rm:
		...
		function Wx(a) {
			this.Jo = ot(a, k);
			this.rl = sq(a);va(this.rl, xd);Na(this.rl, a[M] - 2)
		}
		Wx[K].Zn = function(a, b) {
			...
			d = Mx(b[fb], this.Jo);c[v](d);
			d = Mx(b.Hk, this.rl);c[v](d);return {
				d : c
			}
		};
		Wx[K].gp = function() {
		...
		function Yx(a, b) {
			this.ue = {};W(b.f.vf) && this.Yt(a, b);var c = new Rx(a, this.Zt(a)),
				d = l,
		...
		function Zx(a) {
			...
			this.aw = a;
			this.Me = p;
			this.Nf = 0;Qr(this.sc, Jn, Z(this.Gl, this));this.sc[O]()
		}
		xp(Zx, zr);
		Zx[K].Da = function(a) {
		...
		V.ov = function(a) {
			this.n.f.s.lc = a.va.Fh;this.ya.Da(50)
		};
		V.pv = function() {
			this.n.f.s.lc = l;this.ya.Da(250)
		};
		V.nv = function(a) {
			this.So(a.va.Fh);this.ya.Da(50)
		};
		V.qv = function(a) {
			if (!W(this.n.f.vf))
				this.n.f.vf = 0;
			this.n.f.vf += a.va.cs;this.ya.Da(50)
		};
		V.tv = function(a) {
			var b = this.l,
				c = a.va.$;
		...
		V.mv = function() {
			this.Gk();this.ya.Da(250)
		};
		V.kv = function(a) {
			var b = this.l,
				c = b.vh == Mm,
				d = b.e[a.va.$];
			b.N == oh ? (a = d.c[a.va.Sa].wc, this.n[kb].pk(a, c)) : (a = a.va.Sa, this.n[kb].En(a, d.wc, c));this.ya.Da(50)
		};
		V.fv = function(a) {
			this.n.Ob.s.Md = a.va.Sa;
			this.n.Ob.s.w = this.Un(a.va.$);this.Gk();this.ya.Da(50)
		};
		V.gv = function() {
			this.n.Ob.s.Md = l;
			this.n.Ob.s.w = l;this.ya.Da(250)
		};
		V.ev = function(a) {
			for (var b = this.l.vh == Mm, c = a.va.Sa, d = this.Un(a.va.$), e = 0; e < d[I]; ++e) this.n[kb].En(c, d[e], b);
			a.dd[tc]();this.ya.Da(50)
		};
		V.xv = function(a) {
			var b = this.l.Ic;
			switch (this.l.jc) {
			case ri:
				this.n.s.Xa = a.va.Sa;this.n.s.na = a.va.$;
				...
				if (b == Hj)
					this.n.X.na = a.va.$;
				break;case xh:
				if (a = new $(a.dd[Wb], a.dd[Xb]), Ia(this.n[gc], a), a = this.uk(a), this.n.s.Bb = a, b == Hj)
					this.n.X.Bb = a
			}
			this.ya.Da(50)
		};
		...
		V.Tt = function() {
			...
			a(Lh, this.jv);a(zh, this.hv);a(Ah, this.iv);a(yh, this.tp);a(uk, this.ov);a(vk, this.pv);a(tk, this.nv);a(xk, this.qv);a(wm, this.tv);a(xm, this.uv);a(vm, this.sv);a(bm, this.rv);a(ti, this.lv);a(ui, this.mv);a(si, this.kv);a(ug, this.fv);a(vg, this.gv);a(tg, this.ev);a(bo, this.xv);a(co, this.yv);a($n, this.wv);a(nn, this.vv)
		};
		V.uk = function(a) {
			var b = this.l,
				c = b.a,
			...
			if (a.B) {
				...
				if (a.C) {
					var i = c.ea.ej,
						j = a.C,
						m = new Et;
					m[rb](g.x + j.Ba.x, g.y + j.Ba.y);m.G(g.x + j.Ba.x, g.y + j.Ba.y + i);m.jb(g.x + f.x, g.y + f.y + i, d, e, j.ga, j.ca, k);m.G(g.x + j.Ib.x, g.y + j.Ib.y);m.jb(g.x + f.x, g.y + f.y, d, e, j.ca, j.ga, n);this.g.xa(m, j.b, b)
				}
				...
				a.Xc ? 0 == a.$f && 0 == a.Ye ? this.g.um(f.x, f.y, d, e, a.b, b) : (c = new Et, c[rb](f.x, f.y - e), c.jb(f.x, f.y, d, e, 0, 180, k), c.jb(f.x, f.y, d, e, 180, 360, k), c[rb](f.x, f.y - a.Ye), c.jb(f.x, f.y, a.$f, a.Ye, 360, 180, n), c.jb(f.x, f.y, a.$f, a.Ye, 180, 0, n), c[Ac](), this.g.xa(c, a.b, b)) : (c = new Et, c[rb](g.x + a.jm.x, g.y + a.jm.y), c.G(g.x + a.Ba.x, g.y + a.Ba.y), c.jb(g.x + f.x, g.y + f.y, d, e, a.ga, a.ca, k), c.G(g.x + a.km.x, g.y + a.km.y), c.jb(g.x + f.x, g.y + f.y, a.$f, a.Ye, a.ca, a.ga, n), this.g.xa(c, a.b, b));a.qb && this.wm(a.qb, b);
				if (d = a.xc) {
				...
				g = Hu([ Vm, a[ic] ]);
				b = b.q();this.yc(this.wj, g, b);a.K && this.wh(a.K,
					a[ic]);this.Ia.z && a.z && this.zc(b, {
					click : vm,
					mouseover : wm,
					mouseout : xm
				}, {
		...
		V.wm = function(a, b) {
			if (a.Xc) this.g.um(a.bb.x, a.bb.y, a.ka, a.ua, a.b, b);else {
				var c = new Et;
				c[rb](a.Ba.x, a.Ba.y);c.jb(a.bb.x, a.bb.y, a.ka, a.ua, a.ga, a.ca, k);this.g.xa(c, a.b, b)
			}
		};
		V.Yn = function(a) {
			for (var b = Z(this.yd, this), c = this.g, d = Z(this.zc, this), e = this.di, f = 0; f < a[I]; ++f) {
				var g = a[f],
					...
					j = c.ja(),
					m = new Et;
				m[rb](g.Kb.x + 0.5, g.Kb.y + 0.5);m.G(g.cn + 0.5, g.Kb.y + 0.5);m.G(g.cn + 0.5, g.Lc.y + 0.5);m.G(g.Lc.x + 0.5, g.Lc.y + 0.5);c.xa(m, g.Ha, j);c.Zj(g.Kb.x + 0.5, g.Kb.y + 0.5, g.bn, g.vr, j);b(g.ef, i);b(g.ff, i);c[t](e, i);c[t](e, j);g.z && (g = {
					Fh : g[ic]
				}, i = i.q(), d(i, {
					click : tk,
					mouseover : uk,
		...
		V.Xn = function(a, b) {
			if (!lu(b.Bc, this.se.Bc)) {
				this.g.Ng(this.di);
				var c = new ju(2);
				c.Lb(0, a.Bc || {});c.Lb(1, b.Bc || {});this.Yn(c[ad]())
			}
			this.il(a, this.se);this.hl(a, b)
		};
		V.il = function(a, b) {
		...
		V.hl = function(a, b) {
			for (var c in b.e) {
				var d = a.e[c],
					e = new ju(2);
				e.Lb(0, d);e.Lb(1, b.e[c]);this.Pg(e[ad]())
			}
		};
		function by(a, b, c) {
			this.Bx = b;W(c) && Qr(this, Yl, c);
			this.k = this.l = l;
			this.wb = a;
		...
		V.draw = function(a, b, c) {
			this.Pd.ot();b.isStacked && b.vAxis && b.vAxis.baseline && h(r("Cannot set a non-zero base-line for a stacked chart"));
			var d = b.theme || [];
			jp(d) || (d = [ d ]);
			for (var b = [ b ], e = 0; e < d[I]; ++e) {
				...
				if (np(d[e])) {
					...
					mp(d[e]) ? f = d[e] : h(r("Theme should be a theme name or an options object."));
				b[v](f)
			}
			b[v](Gu);
			this.k = new Nt(b);
			...
			this.n = new Kx(c);this.Pd.st(this.n);
			this.jj = a;this.Rd.Og(Z(this.pt,
				this))
		};
		V.pt = function(a) {
			var b;
			...
			a && b && b.N == c.N && b[w] == c[w] && b[Q] == c[Q] && b.a.top == c.a.top && b.a[P] == c.a[P] && b.a[C] == c.a[C] && b.a[R] == c.a[R] ? (this.l = l, d = wp(), this.kd = {
				...
				Z(this.Qn, this)), this.kd.yk[O]()) : (this.l = c, this.In());this[ub]({
				type : Yl
			})
		};
		V.clearChart = function() {
			this.kd && this.tk();this.Pd.cc();Xr(this.Gd);this.Rd.cc();
			this.Rd = l;Xr(this)
		};
		V.setSelection = function(a) {
			var b = this.yo();
			this.n[kb][Nb](a);this.ji(n);this.xo(b)
		};
		V.getSelection = function() {
		...
		V.yo = function() {
			...
			e = a.f.s;
			f = b.f.s;e.lc != f.lc &&
			(W(f.lc) && d[v](this.li(ll, f.lc, l)), W(e.lc) && d[v](this.li(ml, e.lc, l)));a[kb].Od(b[kb]) || d[v]({
				type : tm
			});return d
		};
		V.li = function(a, b, c) {
			var d = this.l,
				b = d.e[b];
			d.N == Dl ? (c = b.wc, d = l) : (c = d.N == oh ? b.c[c].wc : c, d = b.wc);return {
				type : a,
				row : c,
				column : d
			}
		...
		V.In = function() {
			...
			this.Cg = this.n[Dc]();this.Pd.Wt(this.l)
		};
		V.Qn = function() {
			var a = this.kd;
		...
		function fy(a) {
			lp(a) && (a = 0 !== a.getMilliseconds() ? [ a[Lc](), a.getMonth(), a.getDate(), a.getHours(), a.getMinutes(), a.getSeconds(), a.getMilliseconds() ] : 0 !== a.getSeconds() || 0 !== a.getMinutes() || 0 !== a.getHours() ? [ a[Lc](), a.getMonth(), a.getDate(), a.getHours(), a.getMinutes(), a.getSeconds() ] : [ a[Lc](), a.getMonth(), a.getDate() ], a = xf + a[cd](ie) + fe);return a
		}
		;
		function gy(a) {
			this.Hx = hy++;
			this.ip = this.Hi = U;
			this.ub = Gj;
			this.To = l;mp(a) && 0 < a[cb] || h(r("Container is not defined"));
			this.wb = a;
			this.Vu = Wt(this, a);
			this.ul = n;
			this.qa = l
		...
		V.Xk = function(a, b, c) {
			b = b || {};
			b = ey(b, fy);
			b = (new cs(ba)).Gu(b);bs(b);
			b = cy(b);this.Fu();this.Hu(b);this.Iu(b);Ca(b, b[Qb] || this.ub);
			...
			if (this.Hi != U) {
				...
				g && (iy(d, Pk, g, Rk), iy(d, Kk, g, Mk), iy(d, Gk, g, Gk));e && (iy(d, Hk, e, Gk), iy(d, Sn, e, Nn));f && iy(d, Tn, f, Nn);d.smoothLine && !hp(d.curveType) && (d.curveType = T);iy(d, Bk, d, Ck);iy(d, em, d, fm)
			}
			d = b;jy(d, On, Pn, Rn);jy(d, yk, wk, zk);ky(d.hAxis);
			for (var i in d.hAxes) ky(d.hAxes[i]);
			ky(d.vAxis);
			for (i in d.vAxes) ky(d.vAxes[i]);
			i = d.tooltip;
			if (!W(i)) i = {}, d.tooltip = i;
			jy(d, fo, ao, go);iy(d, go, i, Hn);iy(d, eo, i, An);iy(d, ho, i, no);
			i = d.legend;
			if (W(i)) {
			...
			iy(d, pg, i, Ji);google[wc][Yc][Ic](this.wb);a || h(r("Data table is not defined"));
		...
		V.Hu = function(a) {
			switch (a[F]) {
			case Ak:
				this[jc](T, Ak, Gj);Aa(a, l);
				break;case Cg:
				this[jc](T, Cg, Gj);Aa(a, l);
				break;case gi:
				this[jc](T, Pg, Gj);Aa(a, l);
				break;case Pg:
				this[jc](T, Pg, Ko);Aa(a, l);
				break;case rm:
				this[jc](rm);Aa(a, l);
				break;case Dl:
				this[jc](Dl), Aa(a, l)
			...
			b == U && (b = l);
			var c = a[F] || U;
			c == U && (c = l);!b && !c && h(r("Unspecified chart type."));b && c && b != c && h(r("Incompatible chart types."));Aa(a, b || c)
		};
		V.Iu = function(a) {
			if (a[F] == T) {
				var b = this.ip;
				...
				c == U && (c = l);b && c && b != c && h(r("Incompatible default series types."));
				a.seriesType = b || c
			}
		};
		function ky(a) {
			if (W(a)) {
				jy(a, Dn, Fn, Hn);jy(a, On, Pn, Rn);
				a.gridlines = a.gridlines || {};
				var b = a.gridlines,
					c = a.numberOfSections;
				!hp(b.count) && hp(c) && typeof c == gl && (b.count = c + 1);
				a = a.gridlineColor;!hp(b[tb]) && hp(a) && va(b, a)
			}
		}
		function jy(a, b, c, d) {
			a[d] = a[d] || {};
			d = a[d];iy(a, b, d, Yh);iy(a, c, d, dj)
		}
		function iy(a, b, c, d) {
		...
		function ly(a) {
			gy[N](this, a);this[jc](T, Cg, Gj)
		}
		xp(ly, gy);
		function my(a) {
			gy[N](this, a);this[jc](T, hn, Gj)
		}
		xp(my, gy);
		function ny(a) {
			gy[N](this, a);this[jc](T, U, Gj, bn)
		}
		xp(ny, gy);
		function oy(a) {
			gy[N](this, a);this[jc](T, Ak, Gj)
		}
		xp(oy, gy);
		function py(a) {
			gy[N](this, a);this[jc](rm)
		}
		xp(py, gy);
		function uy(a) {
			gy[N](this, a);this[jc](oh)
		}
		xp(uy, gy);
		function vy(a) {
			gy[N](this, a);this[jc](T, Pg, Ko)
		}
		xp(vy, gy);
		function wy(a) {
			gy[N](this, a);this[jc](T, wh, Gj)
		}
		xp(wy, gy);
		function xy(a) {
			gy[N](this, a);this[jc](T, Pg, Gj)
		}
		xp(xy, gy);
		function yy(a) {
			gy[N](this, a);this[jc](T, U, Gj)
		}
		xp(yy, gy);
		function zy(a) {
			gy[N](this, a);this[jc](Dl)
		}
		xp(zy, gy);
		function Ay(a) {
			this.ed = {};
		...
		V.draw = function(a, b, c) {
			...
			this.Ek = b.be(Wl, 50);
			this.ii = b.za(Zm, this.ii);switch (b.ia(Nh, Dy, vf)) {
			case Hf:
			...
			google[wc][eb].addListener(this.qa, Yl, Z(this.Xt, this, a, c, b.be(Qk)));this.qa[Kc](a, d)
		};
		V.wt = function(a, b) {
		...
		V.Xk = function(a, b) {
			...
			this.ed[Cy.mn] = e;
			c = c.q();Qr(c, Vk, Z(this.gs, this));Qr(c, Wk, Z(this.Jg, this, {
				type : sm,
				Ig : n
			}));Qr(c, Yk, Z(this.sk, this));this.zn(i, fn, fn);this.zn(e, Ni, Ni);Qr(d, Uk, Z(this.xn, this, {
				vb : ih
		...
		V.An = function(a, b, c, d, e, f, g, i, j) {
			var m = s[B](0.5 * d),
				o = g.ja(n);
			g[t](j, o);g.Kg(o.q(), a - m, b);this.Qu(m, 0, c, g, i, o);this.Ru(0, 0.5 * (c - e), d, e, f, g, i, o);return o.q()
		};
		...
		V.setRange = function(a, b) {
			...
			c = this.wn(a, b);return this.mp(c[O], c.end)
		};
		V.mp = function(a, b) {
			var c = this.Zb.Na;
			...
			this.Zb.vb = dm;this.Cp();return k
		};
		V.Cp = function() {
			var a = this.l.ta[0],
				b = a.sb,
			...
			c.vb != Ni && (d = s.min(c.Na[O], c.Na.end), d >= b && (this.Nb.Kg(this.ed[Cy.nn], d - e, 0), this.Nb.Qk(this.ed[Cy.pn], d - b)));c.vb != fn && (d = s.max(c.Na[O], c.Na.end), b = this.ed[Cy.on], c = this.ed[Cy.mn], a >= d && (this.Nb.Qk(b, a - d), this.Nb.no(b, d), this.Nb.Kg(c, d - e, 0)))
		};
		V.gs = function(a) {
			var b = this.Zb;
			if (W(b.vb)) {
				...
				if (b.vb != Ni)
					b.Na.start = b.Na[O] + d;
				b.vb != fn && (b.Na.end += d);this.ki.Da(this.Ek);this.Ck.Da(this.Ek);a[ob]()
			}
		};
		V.gt = function(a, b, c) {
			var d = this.Zb.Na,
				e = this.Zb.vb;
			e == By.vp || e == By.Gv ? (a -= d[O], b -= d.end) : e == By.Hv ? (a -= d[O], b = d.end - d[O] - this.ni) : (a = d[O] - d.end + this.ni, b -= d.end);return pr(c, a, b)
		};
		V.xn = function(a, b) {
			if (b.lp()) {
				var c = this.Zb;
